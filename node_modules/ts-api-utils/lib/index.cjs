...
function canHaveTrailingTrivia(token) {
  switch (token.kind) {
    case ts9__default.default.SyntaxKind.CloseBraceToken:
      return (
        token.parent.kind !== ts9__default.default.SyntaxKind.JsxExpression ||
...
function isJsxElementOrFragment(node) {
  return (
    node.kind === ts9__default.default.SyntaxKind.JsxElement ||
    node.kind === ts9__default.default.SyntaxKind.JsxFragment
  )
}
var [tsMajor, tsMinor] = ts9__default.default.versionMajorMinor
  .split('.')
    ...
    case 'allowSyntheticDefaultImports':
      return options.allowSyntheticDefaultImports !== void 0
        ...
        : isCompilerOptionEnabled(options, 'esModuleInterop') ||
            options.module === ts9__default.default.ModuleKind.System
    case 'alwaysStrict':
    case 'noImplicitAny':
    case 'noImplicitThis':
...
function isAssignmentKind(kind) {
  return (
    kind >= ts9__default.default.SyntaxKind.FirstAssignment &&
    kind <= ts9__default.default.SyntaxKind.LastAssignment
  )
}
...
function getAccessKind(node) {
  ...
  switch (parent.kind) {
    ...
    case ts9__default.default.SyntaxKind.BinaryExpression:
      return parent.right === node
        ...
        : !isAssignmentKind(parent.operatorToken.kind)
          ? 1 /* Read */
          : parent.operatorToken.kind === ts9__default.default.SyntaxKind.EqualsToken
            ? 2 /* Write */
            : 3 /* ReadWrite */
    ...
    case ts9__default.default.SyntaxKind.ExpressionWithTypeArguments:
      return parent.parent.token === ts9__default.default.SyntaxKind.ExtendsKeyword &&
        parent.parent.parent.kind !== ts9__default.default.SyntaxKind.InterfaceDeclaration
        ? 1 /* Read */
        : 0 /* None */
    ...
    case ts9__default.default.SyntaxKind.PrefixUnaryExpression:
      return parent.operator === ts9__default.default.SyntaxKind.PlusPlusToken ||
        parent.operator === ts9__default.default.SyntaxKind.MinusMinusToken
        ? 3 /* ReadWrite */
        : 1 /* Read */
    ...
    switch (node.parent.kind) {
      ...
      case ts9__default.default.SyntaxKind.BinaryExpression:
        return (
          ...
          node.parent.operatorToken.kind === ts9__default.default.SyntaxKind.EqualsToken
        )
      case ts9__default.default.SyntaxKind.ForOfStatement:
...
function hasDecorators(node) {
  return (
    ts9__default.default.isParameter(node) ||
    ts9__default.default.isPropertyDeclaration(node) ||
    ts9__default.default.isMethodDeclaration(node) ||
    ts9__default.default.isGetAccessorDeclaration(node) ||
    ts9__default.default.isSetAccessorDeclaration(node) ||
    ts9__default.default.isClassExpression(node) ||
    ts9__default.default.isClassDeclaration(node)
  )
}
function hasExpressionInitializer(node) {
  return (
    ts9__default.default.isVariableDeclaration(node) ||
    ts9__default.default.isParameter(node) ||
    ts9__default.default.isBindingElement(node) ||
    ts9__default.default.isPropertyDeclaration(node) ||
    ts9__default.default.isPropertyAssignment(node) ||
    ts9__default.default.isEnumMember(node)
  )
}
function hasInitializer(node) {
  return (
    hasExpressionInitializer(node) ||
    ts9__default.default.isForStatement(node) ||
    ts9__default.default.isForInStatement(node) ||
    ts9__default.default.isForOfStatement(node) ||
    ts9__default.default.isJsxAttribute(node)
  )
}
function hasJSDoc(node) {
  if (
    ...
    ts9__default.default.isArrowFunction(node) ||
    ts9__default.default.isBlock(node) ||
    ts9__default.default.isBreakStatement(node) ||
    ts9__default.default.isCallSignatureDeclaration(node) ||
    ts9__default.default.isCaseClause(node) || // eslint-disable-next-line @typescript-eslint/no-deprecated -- Keep compatibility with ts <5
    isClassLikeDeclaration(node) ||
    ts9__default.default.isConstructorDeclaration(node) ||
    ts9__default.default.isConstructorTypeNode(node) ||
    ts9__default.default.isConstructSignatureDeclaration(node) ||
    ts9__default.default.isContinueStatement(node) ||
    ts9__default.default.isDebuggerStatement(node) ||
    ts9__default.default.isDoStatement(node) ||
    ts9__default.default.isEmptyStatement(node) ||
    isEndOfFileToken(node) ||
    ts9__default.default.isEnumDeclaration(node) ||
    ts9__default.default.isEnumMember(node) ||
    ts9__default.default.isExportAssignment(node) ||
    ts9__default.default.isExportDeclaration(node) ||
    ts9__default.default.isExportSpecifier(node) ||
    ts9__default.default.isExpressionStatement(node) ||
    ts9__default.default.isForInStatement(node) ||
    ts9__default.default.isForOfStatement(node) ||
    ts9__default.default.isForStatement(node) ||
    ts9__default.default.isFunctionDeclaration(node) ||
    ts9__default.default.isFunctionExpression(node) ||
    ts9__default.default.isFunctionTypeNode(node) ||
    ts9__default.default.isIfStatement(node) ||
    ts9__default.default.isImportDeclaration(node) ||
    ts9__default.default.isImportEqualsDeclaration(node) ||
    ts9__default.default.isIndexSignatureDeclaration(node) ||
    ts9__default.default.isInterfaceDeclaration(node) ||
    ts9__default.default.isJSDocFunctionType(node) ||
    ts9__default.default.isLabeledStatement(node) ||
    ts9__default.default.isMethodDeclaration(node) ||
    ts9__default.default.isMethodSignature(node) ||
    ts9__default.default.isModuleDeclaration(node) ||
    ts9__default.default.isNamedTupleMember(node) ||
    ts9__default.default.isNamespaceExportDeclaration(node) ||
    ts9__default.default.isParameter(node) ||
    ts9__default.default.isParenthesizedExpression(node) ||
    ts9__default.default.isPropertyAssignment(node) ||
    ts9__default.default.isPropertyDeclaration(node) ||
    ts9__default.default.isPropertySignature(node) ||
    ts9__default.default.isReturnStatement(node) ||
    ts9__default.default.isShorthandPropertyAssignment(node) ||
    ts9__default.default.isSpreadAssignment(node) ||
    ts9__default.default.isSwitchStatement(node) ||
    ts9__default.default.isThrowStatement(node) ||
    ts9__default.default.isTryStatement(node) ||
    ts9__default.default.isTypeAliasDeclaration(node) ||
    ts9__default.default.isVariableDeclaration(node) ||
    ts9__default.default.isVariableStatement(node) ||
    ts9__default.default.isWhileStatement(node) ||
    ts9__default.default.isWithStatement(node)
  ) {
    return true
  }
  ...
  if (
    ...
    (ts9__default.default.isBinaryExpression(node) ||
      ts9__default.default.isElementAccessExpression(node) ||
      ts9__default.default.isIdentifier(node) ||
      ts9__default.default.isJSDocSignature(node) ||
      ts9__default.default.isObjectLiteralExpression(node) ||
      ts9__default.default.isPropertyAccessExpression(node) ||
      ts9__default.default.isTypeParameterDeclaration(node))
  ) {
    return true
  }
  return false
...
function hasType(node) {
  return (
    ...
    ts9__default.default.isPropertySignature(node) ||
    ts9__default.default.isPropertyDeclaration(node) ||
    ts9__default.default.isTypePredicateNode(node) ||
    ts9__default.default.isParenthesizedTypeNode(node) ||
    ts9__default.default.isTypeOperatorNode(node) ||
    ts9__default.default.isMappedTypeNode(node) ||
    ts9__default.default.isAssertionExpression(node) ||
    ts9__default.default.isTypeAliasDeclaration(node) ||
    ts9__default.default.isJSDocTypeExpression(node) ||
    ts9__default.default.isJSDocNonNullableType(node) ||
    ts9__default.default.isJSDocNullableType(node) ||
    ts9__default.default.isJSDocOptionalType(node) ||
    ts9__default.default.isJSDocVariadicType(node)
  )
}
function hasTypeArguments(node) {
  return (
    ts9__default.default.isCallExpression(node) ||
    ts9__default.default.isNewExpression(node) ||
    ts9__default.default.isTaggedTemplateExpression(node) ||
    ts9__default.default.isJsxOpeningElement(node) ||
    ts9__default.default.isJsxSelfClosingElement(node)
  )
}
...
function isArrayBindingElement(node) {
  return (
    ts9__default.default.isBindingElement(node) || ts9__default.default.isOmittedExpression(node)
  )
}
function isArrayBindingOrAssignmentPattern(node) {
  return (
    ts9__default.default.isArrayBindingPattern(node) ||
    ts9__default.default.isArrayLiteralExpression(node)
  )
}
...
function isBindingOrAssignmentElementTarget(node) {
  return (
    ...
    ts9__default.default.isPropertyAccessExpression(node) ||
    ts9__default.default.isElementAccessExpression(node) ||
    ts9__default.default.isOmittedExpression(node)
  )
}
...
function isBindingPattern(node) {
  return (
    ts9__default.default.isObjectBindingPattern(node) ||
    ts9__default.default.isArrayBindingPattern(node)
  )
}
function isBlockLike(node) {
  return (
    ts9__default.default.isSourceFile(node) ||
    ts9__default.default.isBlock(node) ||
    ts9__default.default.isModuleBlock(node) ||
    ts9__default.default.isCaseOrDefaultClause(node)
  )
}
...
function isClassLikeDeclaration(node) {
  return (
    ts9__default.default.isClassDeclaration(node) || ts9__default.default.isClassExpression(node)
  )
}
...
function isDeclarationName(node) {
  return (
    ts9__default.default.isIdentifier(node) ||
    ts9__default.default.isPrivateIdentifier(node) ||
    ts9__default.default.isStringLiteralLike(node) ||
    ts9__default.default.isNumericLiteral(node) ||
    ts9__default.default.isComputedPropertyName(node) ||
    ts9__default.default.isElementAccessExpression(node) ||
...
function isDeclarationWithTypeParameterChildren(node) {
  return (
    isSignatureDeclaration(node) || // eslint-disable-next-line @typescript-eslint/no-deprecated -- Keep compatibility with ts <5
    isClassLikeDeclaration(node) ||
    ts9__default.default.isInterfaceDeclaration(node) ||
    ts9__default.default.isTypeAliasDeclaration(node) ||
    ts9__default.default.isJSDocTemplateTag(node)
  )
}
function isDeclarationWithTypeParameters(node) {
  return (
    isDeclarationWithTypeParameterChildren(node) ||
    ts9__default.default.isJSDocTypedefTag(node) ||
    ts9__default.default.isJSDocCallbackTag(node) ||
    ts9__default.default.isJSDocSignature(node)
  )
}
...
function isJSDocComment(node) {
  ...
  if (isTsVersionAtLeast(4, 4)) {
    return (
      ts9__default.default.isJSDocLink(node) ||
      ts9__default.default.isJSDocLinkCode(node) ||
      ts9__default.default.isJSDocLinkPlain(node)
    )
  }
  return false
}
...
function isJsonObjectExpression(node) {
  return (
    ...
    ts9__default.default.isNumericLiteral(node) ||
    ts9__default.default.isStringLiteral(node) ||
...
function isJsxAttributeLike(node) {
  return (
    ts9__default.default.isJsxAttribute(node) || ts9__default.default.isJsxSpreadAttribute(node)
  )
}
function isJsxAttributeValue(node) {
  return (
    ts9__default.default.isStringLiteral(node) ||
    ts9__default.default.isJsxExpression(node) ||
    ts9__default.default.isJsxElement(node) ||
    ts9__default.default.isJsxSelfClosingElement(node) ||
    ts9__default.default.isJsxFragment(node)
  )
}
function isJsxChild(node) {
  return (
    ts9__default.default.isJsxText(node) ||
    ts9__default.default.isJsxExpression(node) ||
    ts9__default.default.isJsxElement(node) ||
    ts9__default.default.isJsxSelfClosingElement(node) ||
    ts9__default.default.isJsxFragment(node)
...
function isLiteralToken(node) {
  return (
    ts9__default.default.isNumericLiteral(node) ||
    ts9__default.default.isBigIntLiteral(node) ||
    ts9__default.default.isStringLiteral(node) ||
    ts9__default.default.isJsxText(node) ||
    ts9__default.default.isRegularExpressionLiteral(node) ||
    ts9__default.default.isNoSubstitutionTemplateLiteral(node)
  )
}
...
function isModuleReference(node) {
  return (
    ts9__default.default.isEntityName(node) || ts9__default.default.isExternalModuleReference(node)
  )
}
...
function isObjectTypeDeclaration(node) {
  return (
    ...
    isClassLikeDeclaration(node) ||
    ts9__default.default.isInterfaceDeclaration(node) ||
    ts9__default.default.isTypeLiteralNode(node)
  )
}
...
function isPseudoLiteralToken(node) {
  return (
    ts9__default.default.isTemplateHead(node) ||
    ts9__default.default.isTemplateMiddle(node) ||
    ts9__default.default.isTemplateTail(node)
  )
}
function isSignatureDeclaration(node) {
  return (
    ...
    ts9__default.default.isFunctionDeclaration(node) ||
    ts9__default.default.isMethodDeclaration(node) ||
    ts9__default.default.isConstructorDeclaration(node) || // eslint-disable-next-line @typescript-eslint/no-deprecated -- Keep compatibility with ts <5
    isAccessorDeclaration(node) ||
    ts9__default.default.isFunctionExpression(node) ||
    ts9__default.default.isArrowFunction(node)
  )
...
function isTypeOnlyCompatibleAliasDeclaration(node) {
  if (
    ts9__default.default.isImportClause(node) ||
    ts9__default.default.isImportEqualsDeclaration(node) ||
    ts9__default.default.isNamespaceImport(node) ||
    ts9__default.default.isImportOrExportSpecifier(node)
  ) {
    return true
  }
  if (
    isTsVersionAtLeast(5, 0) &&
    (ts9__default.default.isExportDeclaration(node) || ts9__default.default.isNamespaceExport(node))
  ) {
    return true
  }
  return false
...
function isTypeReferenceType(node) {
  return (
    ts9__default.default.isTypeReferenceNode(node) ||
    ts9__default.default.isExpressionWithTypeArguments(node)
  )
}
function isUnionOrIntersectionTypeNode(node) {
  return (
    ts9__default.default.isUnionTypeNode(node) || ts9__default.default.isIntersectionTypeNode(node)
  )
}
function isVariableLikeDeclaration(node) {
  return (
    ...
    ts9__default.default.isShorthandPropertyAssignment(node) ||
    ts9__default.default.isEnumMember(node) ||
    ts9__default.default.isJSDocPropertyTag(node) ||
    ts9__default.default.isJSDocParameterTag(node)
  )
}
...
function isConstAssertionExpression(node) {
  return (
    ts9__default.default.isTypeReferenceNode(node.type) &&
    ts9__default.default.isIdentifier(node.type.typeName) &&
...
function isJSDocNamespaceDeclaration(node) {
  return (
    ts9__default.default.isModuleDeclaration(node) &&
    ts9__default.default.isIdentifier(node.name) &&
    (node.body === void 0 || isJSDocNamespaceBody(node.body))
  )
}
function isJsxTagNamePropertyAccess(node) {
  return (
    ts9__default.default.isPropertyAccessExpression(node) && // eslint-disable-next-line @typescript-eslint/no-deprecated -- Keep compatibility with ts < 5
    isJsxTagNameExpression(node.expression)
  )
}
function isNamedDeclarationWithName(node) {
  return (
    'name' in node && node.name !== void 0 && node.name !== null && isDeclarationName(node.name)
  )
}
...
var IntrinsicTypeFlags =
  ts9__default.default.TypeFlags.Intrinsic ??
  ts9__default.default.TypeFlags.Any |
    ts9__default.default.TypeFlags.Unknown |
    ts9__default.default.TypeFlags.String |
    ts9__default.default.TypeFlags.Number |
    ts9__default.default.TypeFlags.BigInt |
    ts9__default.default.TypeFlags.Boolean |
    ts9__default.default.TypeFlags.BooleanLiteral |
    ts9__default.default.TypeFlags.ESSymbol |
    ts9__default.default.TypeFlags.Void |
    ts9__default.default.TypeFlags.Undefined |
    ts9__default.default.TypeFlags.Null |
    ts9__default.default.TypeFlags.Never |
    ts9__default.default.TypeFlags.NonPrimitive
...
function getWellKnownSymbolPropertyOfType(type, wellKnownSymbolName, typeChecker) {
  ...
  for (const prop of type.getProperties()) {
    ...
    if (
      ...
      declaration.name === void 0 ||
      !ts9__default.default.isComputedPropertyName(declaration.name)
    ) {
      continue
    }
    ...
    if (
      prop.escapedName ===
      getPropertyNameOfWellKnownSymbol(typeChecker, globalSymbol, wellKnownSymbolName)
    ) {
      return prop
    }
  }
...
function isBindableObjectDefinePropertyCall(node) {
  return (
    ...
    ts9__default.default.isPropertyAccessExpression(node.expression) &&
    node.expression.name.escapedText === 'defineProperty' &&
    ts9__default.default.isIdentifier(node.expression.expression) &&
    ...
    if (getPropertyOfType(subType, name) === void 0) {
      const index =
        (isNumericPropertyName(name)
          ? typeChecker.getIndexInfoOfType(subType, ts9__default.default.IndexKind.Number)
          : void 0) ??
        typeChecker.getIndexInfoOfType(subType, ts9__default.default.IndexKind.String)
      if (index?.isReadonly) {
        if (seenProperty) {
          return true
        }
...
function isThenableType(typeChecker, node, type = typeChecker.getTypeAtLocation(node)) {
  for (const constituent of unionConstituents(typeChecker.getApparentType(type))) {
...
function symbolHasReadonlyDeclaration(symbol, typeChecker) {
  return !!(
    (symbol.flags & ts9__default.default.SymbolFlags.Accessor) ===
      ts9__default.default.SymbolFlags.GetAccessor ||
    symbol.declarations?.some(
      node =>
        isModifierFlagSet(node, ts9__default.default.ModifierFlags.Readonly) ||
        (ts9__default.default.isVariableDeclaration(node) &&
          isNodeFlagSet(node.parent, ts9__default.default.NodeFlags.Const)) ||
        (ts9__default.default.isCallExpression(node) &&
...
function typeIsLiteral(type) {
  if (isTsVersionAtLeast(5, 0)) {
    ...
    return isTypeFlagSet(
      type,
      ts9__default.default.TypeFlags.StringLiteral |
        ts9__default.default.TypeFlags.NumberLiteral |
        ts9__default.default.TypeFlags.BigIntLiteral,
    )
  }
}
...
function isCallback(typeChecker, param, node) {
  let type = typeChecker.getApparentType(typeChecker.getTypeOfSymbolAtLocation(param, node))
...
function isReadonlyAssignmentDeclaration(node, typeChecker) {
  ...
  const writableType =
    ...
    ts9__default.default.isPropertyAssignment(writableProp.valueDeclaration)
...
function identifierToKeywordKind(node) {
  return 'originalKeywordKind' in node
    ...
    : ts9__default.default.identifierToKeywordKind(node)
}
...
function getDeclarationDomain(node) {
  switch (node.parent.kind) {
    ...
    case ts9__default.default.SyntaxKind.Parameter:
      if (
        node.parent.parent.kind === ts9__default.default.SyntaxKind.IndexSignature ||
        identifierToKeywordKind(node) === ts9__default.default.SyntaxKind.ThisKeyword
      ) {
        return
      }
    // falls through
...
function getPropertyName(propertyName) {
  if (propertyName.kind === ts9__default.default.SyntaxKind.ComputedPropertyName) {
    ...
    if (ts9__default.default.isPrefixUnaryExpression(expression)) {
      ...
      switch (expression.operator) {
        ...
        // falls through
        case ts9__default.default.SyntaxKind.PlusToken:
          return ts9__default.default.isNumericLiteral(expression.operand)
            ? `${negate ? '-' : ''}${expression.operand.text}`
            : ts9__default.default.isBigIntLiteral(expression.operand)
  ...
  return propertyName.kind === ts9__default.default.SyntaxKind.PrivateIdentifier
    ? void 0
    : propertyName.text
}
...
function getUsageDomain(node) {
  ...
  switch (parent.kind) {
    ...
    case ts9__default.default.SyntaxKind.ExportSpecifier:
      ...
      break
    case ts9__default.default.SyntaxKind.ExpressionWithTypeArguments:
      return parent.parent.token === ts9__default.default.SyntaxKind.ImplementsKeyword ||
        parent.parent.parent.kind === ts9__default.default.SyntaxKind.InterfaceDeclaration
        ? 2 /* Type */
        : 4 /* Value */
    ...
    case ts9__default.default.SyntaxKind.TypeReference:
      return identifierToKeywordKind(node) !== ts9__default.default.SyntaxKind.ConstKeyword
        ? 2 /* Type */
        : void 0
    default:
      return 5 /* ValueOrNamespace */
  ...
  createOrReuseNamespaceScope(name, exported, ambient, hasExportStatement) {
    ...
    this.#innerScope.end((variable, key, scope) => {
      if (
        ...
        (!variable.exported &&
          (!this.#ambient || (this.#exports !== void 0 && !this.#exports.has(key.text))))
      ) {
...
var RootScope = class extends AbstractScope {
  ...
  addVariable(identifier, name, selector, exported, domain) {
    ...
    return this.#innerScope.addVariable(identifier, name, selector, exported, domain)
  }
  end(cb) {
    this.#innerScope.end((value, key) => {
      value.exported ||=
        this.#exportAll || (this.#exports !== void 0 && this.#exports.includes(key.text))
      value.inGlobalScope = this.global
      return cb(value, key, this)
    })
    return super.end((value, key, scope) => {
      value.exported ||=
        scope === this && this.#exports !== void 0 && this.#exports.includes(key.text)
...
var UsageWalker = class {
  ...
  getUsage(sourceFile) {
    ...
    const cb = node => {
      ...
      switch (node.kind) {
        ...
        case ts9__default.default.SyntaxKind.ClassDeclaration:
          this.#handleDeclaration(node, true, 4 /* Value */ | 2 /* Type */)
          return continueWithScope(node, new NonRootScope(this.#scope, 1 /* Function */))
        case ts9__default.default.SyntaxKind.ClassExpression:
          return continueWithScope(
            node,
            node.name !== void 0
              ? new ClassExpressionScope(node.name, this.#scope)
        ...
        case ts9__default.default.SyntaxKind.EnumDeclaration:
          this.#handleDeclaration(node, true, 7 /* Any */)
          return continueWithScope(
            node,
            this.#scope.createOrReuseEnumScope(
              node.name.text,
              includesModifier(node.modifiers, ts9__default.default.SyntaxKind.ExportKeyword),
            ),
          )
        case ts9__default.default.SyntaxKind.EnumMember:
        ...
        case ts9__default.default.SyntaxKind.ImportSpecifier:
        case ts9__default.default.SyntaxKind.NamespaceImport:
          this.#handleDeclaration(node, false, 7 /* Any */ | 8 /* Import */)
          break
        case ts9__default.default.SyntaxKind.InterfaceDeclaration:
        case ts9__default.default.SyntaxKind.TypeAliasDeclaration:
          this.#handleDeclaration(node, true, 2 /* Type */)
          return continueWithScope(node, new NonRootScope(this.#scope, 4 /* Type */))
        ...
        case ts9__default.default.SyntaxKind.Parameter:
          if (
            node.parent.kind !== ts9__default.default.SyntaxKind.IndexSignature &&
            (node.name.kind !== ts9__default.default.SyntaxKind.Identifier ||
              identifierToKeywordKind(node.name) !== ts9__default.default.SyntaxKind.ThisKeyword)
          ) {
        ...
        case ts9__default.default.SyntaxKind.TypeParameter:
          this.#scope.addVariable(
            node.name.text,
            node.name,
            node.parent.kind === ts9__default.default.SyntaxKind.InferType
              ? 8 /* InferType */
              : 7 /* Type */,
            false,
            2 /* Type */,
    ...
    const handleBlockScope = node => {
      if (
        node.kind === ts9__default.default.SyntaxKind.CatchClause &&
  ...
  #handleFunctionLikeDeclaration(node, cb, varCb) {
    ...
    const scope = (this.#scope =
      node.kind === ts9__default.default.SyntaxKind.FunctionExpression && node.name !== void 0
  ...
  #handleVariableDeclaration(declarationList) {
    ...
    const exported =
      declarationList.parent.kind === ts9__default.default.SyntaxKind.VariableStatement &&
      includesModifier(
...
function containsExportStatement(block) {
  for (const statement of block.statements) {
    if (
      statement.kind === ts9__default.default.SyntaxKind.ExportDeclaration ||
      statement.kind === ts9__default.default.SyntaxKind.ExportAssignment
    ) {
      return true
    }
  }
...
function isNamespaceExported(node) {
  return (
    node.parent.kind === ts9__default.default.SyntaxKind.ModuleDeclaration ||
    includesModifier(node.modifiers, ts9__default.default.SyntaxKind.ExportKeyword)
  )
}
