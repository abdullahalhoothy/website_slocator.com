 ...
 * ```
 */
declare function forEachComment(
  node: ts.Node,
...
type BooleanCompilerOptions = keyof {
  [K in keyof ts.CompilerOptions as NonNullable<ts.CompilerOptions[K]> extends boolean
    ? K
    : never]: unknown
}
/**
 ...
 * ```
 */
declare function isCompilerOptionEnabled(
 ...
 * ```
 */
declare function isStrictCompilerOptionEnabled(
  options: ts.CompilerOptions,
 ...
 * ```
 */
declare function includesModifier(
 ...
 */
declare function isConstAssertionExpression(
 ...
 */
declare function isPropertyAccessEntityNameExpression(
  node: ts.Node,
 ...
 */
declare function isSuperElementAccessExpression(
  node: ts.Node,
 ...
 */
declare function isSuperPropertyAccessExpression(
  node: ts.Node,
 ...
 */
declare function isArrayBindingOrAssignmentPattern(
  node: ts.Node,
 ...
 */
declare function isBindingOrAssignmentElementRestIndicator(
  node: ts.Node,
 ...
 */
declare function isBindingOrAssignmentElementTarget(
  node: ts.Node,
 ...
 */
declare function isDeclarationWithTypeParameterChildren(
  node: ts.Node,
 ...
 */
declare function isDeclarationWithTypeParameters(
  node: ts.Node,
 ...
 */
declare function isEntityNameOrEntityNameExpression(
  node: ts.Node,
 ...
 */
declare function isObjectBindingOrAssignmentElement(
  node: ts.Node,
 ...
 */
declare function isObjectBindingOrAssignmentPattern(
  node: ts.Node,
 ...
 */
declare function isTypeOnlyCompatibleAliasDeclaration(
  node: ts.Node,
 ...
 */
declare function isUnionOrIntersectionTypeNode(
  node: ts.Node,
 ...
 * ```
 */
declare function getWellKnownSymbolPropertyOfType(
  type: ts.Type,
 ...
 * ```
 */
declare function isPropertyReadonlyInType(
  type: ts.Type,
  name: ts.__String,
  typeChecker: ts.TypeChecker,
): boolean
 ...
 * ```
 */
declare function isThenableType(
  typeChecker: ts.TypeChecker,
  node: ts.Expression,
  type?: ts.Type,
): boolean
 ...
 */
declare function symbolHasReadonlyDeclaration(
  symbol: ts.Symbol,
  typeChecker: ts.TypeChecker,
): boolean
/**
...
export {
  ...
  DeclarationDomain,
  type FalseKeyword,
  type FalseLiteralType,
  type ForEachCommentCallback,
  type ForEachTokenCallback,
  type FreshableIntrinsicType,
  type ImportKeyword,
  type IntrinsicAnyType,
  type IntrinsicBigIntType,
  type IntrinsicBooleanType,
  type IntrinsicESSymbolType,
  type IntrinsicErrorType,
  type IntrinsicNeverType,
  type IntrinsicNonPrimitiveType,
  type IntrinsicNullType,
  type IntrinsicNumberType,
  type IntrinsicStringType,
  type IntrinsicType,
  type IntrinsicUndefinedType,
  type IntrinsicUnknownType,
  type IntrinsicVoidType,
  type NamedDeclarationWithName,
  type NeverKeyword,
  type NullKeyword,
  type NumberKeyword,
  ...
  type ThisKeyword,
  type TrueKeyword,
  type TrueLiteralType,
  type UndefinedKeyword,
  type UnknownKeyword,
  type UnknownLiteralType,
  UsageDomain,
  type UsageInfo as VariableInfo,
  type Usage as VariableUse,
  type VoidKeyword,
