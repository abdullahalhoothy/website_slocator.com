!(function (e, t) {
  ...
  const e = e => 'string' == typeof e,
    ...
    s = e => (null == e ? '' : String(e)),
    i = /###/g,
    o = e => (e && e.includes('###') ? e.replace(i, '.') : e),
    n = t => !t || e(t),
    r = (t, s, i) => {
      const r = e(s) ? s.split('.') : s
      let a = 0
      for (; a < r.length - 1; ) {
        if (n(t)) return {}
        const e = o(r[a])
      ...
      return n(t) ? {} : { obj: t, k: o(r[a]) }
    },
    a = (e, t, s) => {
      const { obj: i, k: o } = r(e, t, Object)
      if (void 0 !== i || 1 === t.length) return void (i[o] = s)
      let n = t[t.length - 1],
        a = t.slice(0, t.length - 1),
        l = r(e, a, Object)
      for (; void 0 === l.obj && a.length; )
        ((n = `${a[a.length - 1]}.${n}`),
          (a = a.slice(0, a.length - 1)),
          (l = r(e, a, Object)),
          l?.obj && void 0 !== l.obj[`${l.k}.${n}`] && (l.obj = void 0))
      l.obj[`${l.k}.${n}`] = s
    },
    l = (e, t) => {
      const { obj: s, k: i } = r(e, t)
    ...
    c = (t, s, i) => {
      for (const o in s)
        '__proto__' !== o &&
          'constructor' !== o &&
          (o in t
            ? e(t[o]) || t[o] instanceof String || e(s[o]) || s[o] instanceof String
              ? i && (t[o] = s[o])
              : c(t[o], s[o], i)
            : (t[o] = s[o]))
      return t
    ...
    f = (e, t, s = '.') => {
      ...
      for (let e = 0; e < i.length; ) {
        ...
        for (let r = e; r < i.length; ++r)
          if ((r !== e && (n += s), (n += i[r]), (t = o[n]), void 0 !== t)) {
            if (['string', 'number', 'boolean'].includes(typeof t) && r < i.length - 1) continue
            e += r - e + 1
            break
          }
        o = t
  ...
  class v {
    ...
    forward(t, s, i, o) {
      return o && !this.debug
        ? null
        : ((t = t.map(t => (e(t) ? t.replace(/[\r\n\x00-\x1F\x7F]/g, ' ') : t))),
          e(t[0]) && (t[0] = `${i}${this.prefix} ${t[0]}`),
          this.logger[s](t))
    }
    create(e) {
    ...
    on(e, t) {
      return (
        e.split(' ').forEach(e => {
          ...
          const s = this.observers[e].get(t) || 0
  ...
  class k extends x {
    ...
    getResource(t, s, i, o = {}) {
      ...
      t.includes('.')
        ? (a = t.split('.'))
        : ((a = [t, s]),
          i && (Array.isArray(i) ? a.push(...i) : e(i) && n ? a.push(...i.split(n)) : a.push(i)))
      const c = l(this.data, a)
      return (
        c || s || i || !t.includes('.') || ((t = a[0]), (s = a[1]), (i = a.slice(2).join('.'))),
        !c && r && e(i) ? f(this.data?.[t]?.[s], i, n) : c
      )
    }
    addResource(e, t, s, i, o = { silent: !1 }) {
      const n = void 0 !== o.keySeparator ? o.keySeparator : this.options.keySeparator
      let r = [e, t]
      ;(s && (r = r.concat(n ? s.split(n) : s)),
        e.includes('.') && ((r = e.split('.')), (i = t), (t = r[1])),
        this.addNamespaces(t),
        a(this.data, r, i),
        o.silent || this.emit('added', e, t, s, i))
    }
    addResources(t, s, i, o = { silent: !1 }) {
      for (const o in i)
        (e(i[o]) || Array.isArray(i[o])) && this.addResource(t, s, o, i[o], { silent: !0 })
      o.silent || this.emit('added', t, s, i)
    }
    addResourceBundle(e, t, s, i, o, n = { silent: !1, skipCopy: !1 }) {
      let r = [e, t]
      ;(e.includes('.') && ((r = e.split('.')), (i = s), (s = t), (t = r[1])),
        this.addNamespaces(t))
      let h = l(this.data, r) || {}
  ...
  const L = Symbol('i18next/PATH_KEY')
  function w(e, t) {
    const { [L]: s } = e(
        (function () {
          const e = [],
          ...
          return (
            (t.get = (i, o) => (
              s?.revoke?.(),
              o === L ? e : (e.push(o), (s = Proxy.revocable(i, t)), s.proxy)
            )),
    ...
    if (s.length > 1 && o) {
      const e = t?.ns,
        n = Array.isArray(e) ? e : null
      if (n && n.length > 1 && n.slice(1).includes(s[0])) return `${s[0]}${o}${s.slice(1).join(i)}`
    }
    return s.join(i)
  }
  const $ = t => !e(t) && 'boolean' != typeof t && 'number' != typeof t
  class R extends x {
    constructor(e, t = {}) {
      var s, i
      ;(super(),
    ...
    exists(e, t = { interpolation: {} }) {
      ...
      if (void 0 === i?.res) return !1
      const o = $(i.res)
      return !1 !== s.returnObjects || !o
    }
    extractFromKey(t, s) {
      let i = void 0 !== s.nsSeparator ? s.nsSeparator : this.options.nsSeparator
      void 0 === i && (i = ':')
      const o = void 0 !== s.keySeparator ? s.keySeparator : this.options.keySeparator
      let n = s.ns || this.options.defaultNS || []
      const r = i && t.includes(i),
        a = !(
          ...
          ((e, t, s) => {
            ;((t = t || ''), (s = s || ''))
            const i = g.filter(e => !t.includes(e) && !s.includes(e))
            if (0 === i.length) return !0
            const o = d.getRegExp(`(${i.map(e => ('?' === e ? '\\?' : e)).join('|')})`)
            let n = !o.test(e)
            if (!n) {
              const t = e.indexOf(s)
              t > 0 && !o.test(e.substring(0, t)) && (n = !0)
            }
            return n
          })(t, i, o)
        )
      if (r && !a) {
        ...
        if (s && s.length > 0) return { key: t, namespaces: e(n) ? [n] : n }
        const r = t.split(i)
        ;((i !== o || (i === o && this.options.ns.includes(r[0]))) && (n = r.shift()),
          (t = r.join(o)))
      }
      return { key: t, namespaces: e(n) ? [n] : n }
    }
    translate(t, s, i) {
      let o = 'object' == typeof s ? { ...s } : s
      if (
        ('object' != typeof o &&
        ...
        return ''
      ;('function' == typeof t && (t = w(t, { ...this.options, ...o })),
        Array.isArray(t) || (t = [String(t)]),
        (t = t.map(e => ('function' == typeof e ? w(e, { ...this.options, ...o }) : String(e)))))
      const n = void 0 !== o.returnDetails ? o.returnDetails : this.options.returnDetails,
        r = void 0 !== o.keySeparator ? o.keySeparator : this.options.keySeparator,
        { key: a, namespaces: l } = this.extractFromKey(t[t.length - 1], o),
        c = l[l.length - 1]
      let h = void 0 !== o.nsSeparator ? o.nsSeparator : this.options.nsSeparator
      void 0 === h && (h = ':')
      const u = o.lng || this.language,
      ...
      const f = g?.usedKey || a,
        ...
        b = void 0 !== o.count && !e(o.count),
        x = R.hasDefaultValue(o),
        k = b ? this.pluralResolver.getSuffix(u, o.count, o) : '',
        S = o.ordinal && b ? this.pluralResolver.getSuffix(u, o.count, { ordinal: !1 }) : '',
        L = b && !o.ordinal && 0 === o.count,
        O =
          (L && o[`defaultValue${this.options.pluralSeparator}zero`]) ||
          o[`defaultValue${k}`] ||
          o[`defaultValue${S}`] ||
          o.defaultValue
      let C = d
      v && !d && x && (C = O)
      const P = $(C),
        j = Object.prototype.toString.apply(C)
      if (
        !(v && C && P) ||
        ['[object Number]', '[object Function]', '[object RegExp]'].includes(j) ||
        (e(y) && Array.isArray(C))
      )
        if (v && e(y) && Array.isArray(d))
          ((d = d.join(y)), d && (d = this.extendTranslation(d, t, o, i)))
        else {
          let e = !1,
            s = !1
          ;(!this.isValidLookup(d) && x && ((e = !0), (d = O)),
            this.isValidLookup(d) || ((s = !0), (d = a)))
          const n =
              (o.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && s
                ? void 0
                : d,
            l = x && O !== d && this.options.updateMissing
          if (s || e || l) {
            if (
              (this.logger.log(
                ...
                u,
                c,
                b && !l ? `${a}${this.pluralResolver.getSuffix(u, o.count, o)}` : a,
                l ? O : d,
              ),
              r)
            ) {
              const e = this.resolve(a, { ...o, keySeparator: !1 })
              e &&
                e.res &&
                this.logger.warn(
            ...
            const s = (e, t, s) => {
              ...
              ;(this.options.missingKeyHandler
                ? this.options.missingKeyHandler(e, c, t, i, l, o)
                : this.backendConnector?.saveMissing &&
                  this.backendConnector.saveMissing(e, c, t, i, l, o),
                this.emit('missingKey', e, c, t, d))
            }
              ...
              (this.options.saveMissingPlurals && b
                ? e.forEach(e => {
                    ...
                    ;(L &&
                      ...
                      t.forEach(t => {
                        s([e], a + t, o[`defaultValue${t}`] || O)
                      }))
                  })
                : s(e, a, O))
          }
          ;((d = this.extendTranslation(d, t, o, g, i)),
            s && d === a && this.options.appendNamespaceToMissingKey && (d = `${c}${h}${a}`),
            (s || e) &&
              this.options.parseMissingKeyHandler &&
              (d = this.options.parseMissingKeyHandler(
                this.options.appendNamespaceToMissingKey ? `${c}${h}${a}` : a,
                e ? d : void 0,
                o,
              )))
        }
        ...
        if (!o.returnObjects && !this.options.returnObjects) {
          ...
          const e = this.options.returnedObjectHandler
            ? this.options.returnedObjectHandler(f, C, { ...o, ns: l })
            : `key '${a} (${this.language})' returned an object instead of string.`
          return n ? ((g.res = e), (g.usedParams = this.getUsedParamsDetails(o)), g) : e
        }
        if (r) {
            ...
            if (Object.prototype.hasOwnProperty.call(C, e)) {
              ...
              ;((t[e] =
                x && !d
                  ? this.translate(i, {
                      ...o,
                      defaultValue: $(O) ? O[e] : void 0,
                      joinArrays: !1,
                      ns: l,
                    })
                  : this.translate(i, { ...o, joinArrays: !1, ns: l })),
                t[e] === i && (t[e] = C[e]))
            }
          d = t
        }
      }
      return n ? ((g.res = d), (g.usedParams = this.getUsedParamsDetails(o)), g) : d
    }
    extendTranslation(t, s, i, o, n) {
      if (this.i18nFormat?.parse)
        ...
        let l = i.replace && !e(i.replace) ? i.replace : i
        if (
          (this.options.interpolation.defaultVariables &&
            (l = { ...this.options.interpolation.defaultVariables, ...l }),
          (t = this.interpolator.interpolate(t, l, i.lng || this.language || o.usedLng, i)),
          r)
        ) {
          const e = t.match(this.interpolator.nestingRegexp)
          a < (e && e.length) && (i.nest = !1)
        }
            ...
            (t = this.interpolator.nest(
              ...
              (...e) =>
                n?.[0] !== e[0] || i.context
                  ? this.translate(...e, s)
                  : (this.logger.warn(
                      `It seems you are nesting recursively key: ${e[0]} in key: ${s[0]}`,
                    ),
                    null),
              i,
            )),
        ...
        null != t &&
          ...
          (t = S.handle(
            ...
            this.options && this.options.postProcessPassResolved
              ? { i18nResolved: { ...o, usedParams: this.getUsedParamsDetails(i) }, ...i }
              : i,
            this,
          )),
        t
    ...
    resolve(t, s = {}) {
      ...
      return (
        e(t) && (t = [t]),
        Array.isArray(t) &&
          (t = t.map(e => ('function' == typeof e ? w(e, { ...this.options, ...s }) : e))),
        t.forEach(t => {
          if (this.isValidLookup(i)) return
          const l = this.extractFromKey(t, s),
            c = l.key
          o = c
          let h = l.namespaces
          this.options.fallbackNS && (h = h.concat(this.options.fallbackNS))
          const u = void 0 !== s.count && !e(s.count),
            p = u && !s.ordinal && 0 === s.count,
            g =
              void 0 !== s.context &&
              (e(s.context) || 'number' == typeof s.context) &&
              '' !== s.context,
            d = s.lngs
              ? s.lngs
          ...
          h.forEach(e => {
            this.isValidLookup(i) ||
              ...
              this.checkedLoadedFor[`${d[0]}-${e}`] ||
                ...
                this.logger.warn(
                  `key "${o}" for languages "${d.join(', ')}" won't get resolved as namespace "${a}" was not yet loaded`,
              ...
              d.forEach(t => {
                ...
                r = t
                const o = [c]
                if (this.i18nFormat?.addLookupKeys) this.i18nFormat.addLookupKeys(o, c, t, e, s)
                else {
                  let e
                  u && (e = this.pluralResolver.getSuffix(t, s.count, s))
                  ...
                  if (
                    (u &&
                      (s.ordinal &&
                        e.startsWith(n) &&
                        o.push(c + e.replace(n, this.options.pluralSeparator)),
                      o.push(c + e),
                      p && o.push(c + i)),
                    g)
                  ) {
                    const t = `${c}${this.options.contextSeparator || '_'}${s.context}`
                    ;(o.push(t),
                      u &&
                        (s.ordinal &&
                          e.startsWith(n) &&
                          o.push(t + e.replace(n, this.options.pluralSeparator)),
                        o.push(t + e),
                        p && o.push(t + i)))
                  }
                }
                let a
                for (; (a = o.pop()); )
                  this.isValidLookup(i) || ((n = a), (i = this.getResource(t, e, a, s)))
              }))
          })
        }),
        { res: i, usedKey: o, exactUsedKey: n, usedLng: r, usedNS: a }
      )
    }
    isValidLookup(e) {
      return !(
    ...
    getUsedParamsDetails(t = {}) {
      const s = [
        ...
        i = t.replace && !e(t.replace)
      let o = i ? t.replace : t
      if (
        (i && void 0 !== t.count && (o.count = t.count),
        this.options.interpolation.defaultVariables &&
          (o = { ...this.options.interpolation.defaultVariables, ...o }),
        !i)
      ) {
        o = { ...o }
        for (const e of s) delete o[e]
      }
      return o
    }
  ...
  class O {
    ...
    getScriptPartFromCode(e) {
      if (!(e = m(e)) || !e.includes('-')) return null
      const t = e.split('-')
      return 2 === t.length
        ? null
        : (t.pop(),
    ...
    formatLanguageCode(t) {
      if (e(t) && t.includes('-')) {
        ...
        return (
          e && this.options.lowerCaseLng && (e = e.toLowerCase()),
    ...
    getBestMatchFromCodes(e) {
      ...
      return (
        ...
        !t &&
          ...
          e.forEach(e => {
            if (t) return
            const s = this.getScriptPartFromCode(e)
    ...
    getFallbackCodes(t, s) {
      if (!t) return []
      if (('function' == typeof t && (t = t(s)), e(t) && (t = [t]), Array.isArray(t))) return t
      if (!s) return t.default || []
      let i = t[s]
      return (
        i || (i = t[this.getScriptPartFromCode(s)]),
        i || (i = t[this.formatLanguageCode(s)]),
        i || (i = t[this.getLanguagePartFromCode(s)]),
        i || (i = t.default),
        i || []
      )
    }
    toResolveHierarchy(t, s) {
      const i = this.getFallbackCodes((!1 === s ? [] : s) || this.options.fallbackLng || [], t),
        o = [],
        n = e => {
          e &&
      ...
      return (
        e(t) && (t.includes('-') || t.includes('_'))
          ? ('languageOnly' !== this.options.load && n(this.formatLanguageCode(t)),
            'languageOnly' !== this.options.load &&
              'currentOnly' !== this.options.load &&
              n(this.getScriptPartFromCode(t)),
            'currentOnly' !== this.options.load && n(this.getLanguagePartFromCode(t)))
          : e(t) && n(this.formatLanguageCode(t)),
        i.forEach(e => {
          o.includes(e) || n(this.formatLanguageCode(e))
        }),
        o
      )
    }
  }
  const C = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
    P = {
  ...
  class j {
    ...
    getRule(e, t = {}) {
      const s = m('dev' === e ? 'en' : e),
        i = t.ordinal ? 'ordinal' : 'cardinal',
        o = JSON.stringify({ cleanedCode: s, type: i })
      ...
      try {
        ...
        if ('undefined' == typeof Intl)
          return (this.logger.error('No Intl support, please use an Intl polyfill!'), P)
    ...
    getSuffixes(e, t = {}) {
      ...
      return (
        ...
        s
          ? s
              .resolvedOptions()
              .pluralCategories.sort((e, t) => C[e] - C[t])
              .map(
                e =>
  ...
  const N = (t, s, i, o = '.', n = !0) => {
      let r = ((e, t, s) => {
        const i = l(e, s)
        return void 0 !== i ? i : l(t, s)
      })(t, s, i)
      return (!r && n && e(i) && ((r = f(t, i, o)), void 0 === r && (r = f(s, i, o))), r)
    },
    E = e => e.replace(/\$/g, '$$$$')
  class F {
    constructor(e = {}) {
    ...
    init(e = {}) {
      ...
      ;((this.escape = void 0 !== t ? t : p),
        (this.escapeValue = void 0 === s || s),
        (this.useRawValueToEscape = void 0 !== i && i),
        (this.prefix = o ? h(o) : n || '{{'),
        (this.suffix = r ? h(r) : a || '}}'),
        (this.formatSeparator = l || ','),
        (this.unescapePrefix = c ? '' : u ? h(u) : '-'),
        (this.unescapeSuffix = this.unescapePrefix ? '' : c ? h(c) : ''),
        (this.nestingPrefix = g ? h(g) : d || h('$t(')),
        (this.nestingSuffix = f ? h(f) : m || h(')')),
    ...
    interpolate(t, i, o, n) {
      ...
      const c =
        ...
        h = e => {
          if (!e.includes(this.formatSeparator)) {
            const t = N(i, c, e, this.options.keySeparator, this.options.ignoreJSONStructure)
            return this.alwaysFormat
              ? this.format(t, void 0, o, { ...n, ...i, interpolationkey: e })
              : t
          }
          ...
          return this.format(
            N(i, c, s, this.options.keySeparator, this.options.ignoreJSONStructure),
            r,
            o,
            { ...n, ...i, interpolationkey: s },
          )
        }
      ;(this.resetRegExp(),
        !this.escapeValue &&
      ...
      const u = n?.missingInterpolationHandler || this.options.missingInterpolationHandler,
        p =
      ...
      return (
        [
          { regex: this.regexpUnescape, safeValue: e => E(e) },
          { regex: this.regexp, safeValue: e => (this.escapeValue ? E(this.escape(e)) : E(e)) },
        ].forEach(i => {
          for (l = 0; (r = i.regex.exec(t)); ) {
            const o = r[1].trim()
            if (((a = h(o)), void 0 === a))
              if ('function' == typeof u) {
                const s = u(t, r, n)
                a = e(s) ? s : ''
              } else if (n && Object.prototype.hasOwnProperty.call(n, o)) a = ''
              else {
                if (p) {
                  a = r[0]
                  continue
            ...
            else e(a) || this.useRawValueToEscape || (a = s(a))
            const c = i.safeValue(a)
            if (
              ((t = t.replace(r[0], c)),
              p
                ? ((i.regex.lastIndex += a.length), (i.regex.lastIndex -= r[0].length))
                : (i.regex.lastIndex = 0),
              l++,
              l >= this.maxReplaces)
            )
    ...
    nest(t, i, o = {}) {
      ...
      const l = (e, t) => {
        ...
        const i = e.split(new RegExp(`${h(s)}[ ]*{`))
        let o = `{${i[1]}`
        ;((e = i[0]), (o = this.interpolate(o, a)))
        const n = o.match(/'/g),
          r = o.match(/"/g)
        ;(((n?.length ?? 0) % 2 == 0 && !r) || (r?.length ?? 0) % 2 != 0) &&
          (o = o.replace(/'/g, '"'))
        try {
      ...
      for (; (n = this.nestingRegexp.exec(t)); ) {
        let c = []
        ;((a = { ...o }),
          (a = a.replace && !e(a.replace) ? a.replace : a),
          (a.applyPostProcessor = !1),
          delete a.defaultValue)
        const h = /{.*}/.test(n[1]) ? n[1].lastIndexOf('}') + 1 : n[1].indexOf(this.formatSeparator)
        if (
          (-1 !== h &&
            ((c = n[1]
              .slice(h)
              ...
              .filter(Boolean)),
            (n[1] = n[1].slice(0, h))),
          (r = i(l.call(this, n[1].trim(), a), a)),
          r && n[0] === t && !e(r))
        )
          return r
        ;(e(r) || (r = s(r)),
          r || (this.logger.warn(`missed to resolve ${n[1]} for nesting ${t}`), (r = '')),
          c.length &&
            (r = c.reduce(
              (e, t) => this.format(e, t, o.lng, { ...o, interpolationkey: n[1].trim() }),
              r.trim(),
            )),
          (t = t.replace(n[0], r)),
  ...
  const V = e => {
      ...
      return (s, i, o) => {
        ...
        o &&
          ...
          (n = { ...n, [o.interpolationkey]: void 0 })
        const r = i + JSON.stringify(n)
        let a = t[r]
        return (a || ((a = e(m(i), o)), (t[r] = a)), a(s))
      }
    },
    T = e => (t, s, i) => e(m(s), i)(t)
  class I {
    ...
    init(e, t = { interpolation: {} }) {
      ...
      const s = t.cacheInBuiltFormats ? V : T
      this.formats = {
        number: s((e, t) => {
    ...
    format(e, t, s, i = {}) {
      ...
      if (
        ...
        const e = o.findIndex(e => e.includes(')'))
        o[0] = [o[0], ...o.splice(1, e)].join(this.formatSeparator)
      }
      return o.reduce((e, t) => {
        const { formatName: o, formatOptions: n } = (e => {
        ...
        if (this.formats[o]) {
          let t = e
          try {
            const r = i?.formatParams?.[i.interpolationkey] || {},
              a = r.locale || r.lng || i.locale || i.lng || s
            t = this.formats[o](e, a, { ...n, ...i, ...r })
          } catch (e) {
            this.logger.warn(e)
          }
          return t
  ...
  class D extends x {
    ...
    loaded(e, t, s) {
      const i = e.split('|'),
        o = i[0],
        n = i[1]
      ;(t && this.emit('failedLoading', o, n, t),
        !t && s && this.store.addResourceBundle(o, n, s, void 0, void 0, { skipCopy: !0 }),
        (this.state[e] = t ? -1 : 2),
        t && s && (this.state[e] = 0))
      const a = {}
    ...
    read(e, t, s, i = 0, o = this.retryTimeout, n) {
      ...
      const r = (r, a) => {
          ...
          r && a && i < this.maxRetries
            ? setTimeout(() => {
                this.read(e, t, s, i + 1, 2 * o, n)
              }, o)
            : n(r, a)
        },
    ...
    prepareLoading(t, s, i = {}, o) {
      if (!this.backend)
        return (
          this.logger.warn('No backend was added via i18next.use. Will not load resources.'),
          o && o()
        )
      ;(e(t) && (t = this.languageUtils.toResolveHierarchy(t)), e(s) && (s = [s]))
      const n = this.queueLoad(t, s, i, o)
      if (!n.toLoad.length) return (n.pending.length || o(), null)
      n.toLoad.forEach(e => {
        this.loadOne(e)
      })
    }
    ...
    loadOne(e, t = '') {
      const s = e.split('|'),
        i = s[0],
        o = s[1]
      this.read(i, o, 'read', void 0, void 0, (s, n) => {
        ;(s && this.logger.warn(`${t}loading namespace ${o} for language ${i} failed`, s),
          !s && n && this.logger.log(`${t}loaded namespace ${o} for language ${i}`, n),
          this.loaded(e, s, n))
      })
    }
    saveMissing(e, t, s, i, o, n = {}, r = () => {}) {
      if (
        ...
        if (null != s && '' !== s) {
          if (this.backend?.create) {
            const a = { ...n, isUpdate: o },
              l = this.backend.create.bind(this.backend)
            if (l.length < 6)
              try {
                let o
                ;((o = 5 === l.length ? l(e, t, s, i, a) : l(e, t, s, i)),
  ...
  const A = () => ({
      ...
      overloadTranslationOptionHandler: t => {
        let s = {}
        if (
          ('object' == typeof t[1] && (s = t[1]),
          e(t[1]) && (s.defaultValue = t[1]),
          e(t[2]) && (s.tDescription = t[2]),
  ...
  class M extends x {
    constructor(e = {}, t) {
      ...
      if (
        ...
        (s = this),
        Object.getOwnPropertyNames(Object.getPrototypeOf(s)).forEach(e => {
          'function' == typeof s[e] && (s[e] = s[e].bind(s))
        }),
    ...
    init(s = {}, i) {
      ;((this.isInitializing = !0),
        'function' == typeof s && ((i = s), (s = {})),
        null == s.defaultNS &&
          s.ns &&
          (e(s.ns)
            ? (s.defaultNS = s.ns)
            : s.ns.includes('translation') || (s.defaultNS = s.ns[0])))
      const o = A()
      ;((this.options = { ...o, ...this.options, ...K(s) }),
        (this.options.interpolation = { ...o.interpolation, ...this.options.interpolation }),
        void 0 !== s.keySeparator && (this.options.userDefinedKeySeparator = s.keySeparator),
        void 0 !== s.nsSeparator && (this.options.userDefinedNsSeparator = s.nsSeparator),
        'function' != typeof this.options.overloadTranslationOptionHandler &&
          (this.options.overloadTranslationOptionHandler = o.overloadTranslationOptionHandler))
      const n = e => (e ? ('function' == typeof e ? new e() : e) : null)
      if (!this.options.isClone) {
        let e
        ;(this.modules.logger
          ? b.init(n(this.modules.logger), this.options)
          : b.init(null, this.options),
          (e = this.modules.formatter ? this.modules.formatter : I))
        const t = new O(this.options)
        this.store = new k(this.options.resources, this.options)
        const s = this.services
        ;((s.logger = b),
          (s.resourceStore = this.store),
          (s.languageUtils = t),
          (s.pluralResolver = new j(t, { prepend: this.options.pluralSeparator })),
          e &&
            ((s.formatter = n(e)),
          ...
          (s.backendConnector = new D(n(this.modules.backend), s.resourceStore, s, this.options)),
      ...
      return (this.options.resources || !this.options.initAsync ? a() : setTimeout(a, 0), r)
    }
    loadResources(t, s = U) {
      let i = s
      const o = e(t) ? t : this.language
      if (
    ...
    changeLanguage(s, i) {
      ...
      const n = e => {
        ...
        a = t => {
          s || t || !this.services.languageDetector || (t = [])
          const i = e(t) ? t : t && t[0],
            o = this.store.hasLanguageSomeTranslations(i)
              ? i
              : this.services.languageUtils.getBestMatchFromCodes(e(t) ? [t] : t)
          ;(o &&
            (this.language || n(o),
      ...
      return (
        s || !this.services.languageDetector || this.services.languageDetector.async
          ? !s && this.services.languageDetector && this.services.languageDetector.async
    ...
    getFixedT(t, s, i) {
      const o = (e, t, ...s) => {
        ...
        ;((n =
          'object' != typeof t
            ? this.options.overloadTranslationOptionHandler([e, t].concat(s))
            : { ...t }),
          (n.lng = n.lng || o.lng),
          (n.lngs = n.lngs || o.lngs),
          (n.ns = n.ns || o.ns),
          '' !== n.keyPrefix && (n.keyPrefix = n.keyPrefix || i || o.keyPrefix))
        const r = { ...this.options, ...n }
        'function' == typeof n.keyPrefix && (n.keyPrefix = w(n.keyPrefix, r))
        const a = this.options.keySeparator || '.'
        let l
        return (
          n.keyPrefix && Array.isArray(e)
            ? (l = e.map(e => ('function' == typeof e && (e = w(e, r)), `${n.keyPrefix}${a}${e}`)))
            : ('function' == typeof e && (e = w(e, r)),
              (l = n.keyPrefix ? `${n.keyPrefix}${a}${e}` : e)),
          this.t(l, n)
        )
      }
      return (e(t) ? (o.lng = t) : (o.lngs = t), (o.ns = s), (o.keyPrefix = i), o)
    }
    t(...e) {
    ...
    hasLoadedNamespace(e, t = {}) {
      ...
      const n = (e, t) => {
        const s = this.services.backendConnector.state[`${e}|${t}`]
        return -1 === s || 0 === s || 2 === s
      }
      if (t.precheck) {
        const e = t.precheck(this, n)
    ...
    loadLanguages(s, i) {
      ...
      const n = this.options.preload || [],
        r = s.filter(e => !n.includes(e) && this.services.languageUtils.isSupportedCode(e))
      return r.length
    ...
    dir(e) {
      ...
      const t = this.services?.languageUtils || new O(A())
    ...
    static createInstance(e = {}, t) {
      const s = new M(e, t)
      return ((s.createInstance = M.createInstance), s)
    }
    cloneInstance(e = {}, t = U) {
      ...
      if (
        ...
        ;((o.store = new k(e, i)), (o.services.resourceStore = o.store))
      }
      if (e.interpolation) {
        const t = { ...A().interpolation, ...this.options.interpolation, ...e.interpolation },
          s = { ...i, interpolation: t }
        o.services.interpolator = new F(s)
      }
      return (
        (o.translator = new R(o.services, i)),
        o.translator.on('*', (e, ...t) => {
          o.emit(e, ...t)
        }),
        o.init(i, t),
  ...
  const H = M.createInstance()
  return ((H.keyFromSelector = w), H)
})
