    ...
    <div className="border-b border-slate-200 last:border-0 flex flex-col bg-white">
      <div className="flex flex-col md:flex-row w-full min-h-[80px]">
        ...
        <div className="w-full md:w-[25%] flex flex-col justify-center text-center p-5 bg-white">
          <span className="font-bold text-[#6b21a8] text-[16px] mb-1 leading-snug">{item.feature}</span>
          {item.desc && (
            <button 
            ...
            >
              {isExpanded ? t('territoryAdvantages.table.hideDetails') : t('territoryAdvantages.table.whyImportant')}
      ...
      <div className={`transition-all duration-500 ease-in-out overflow-hidden bg-slate-50/50 ${isExpanded ? 'max-h-[500px] opacity-100 border-t border-slate-200' : 'max-h-0 opacity-0'}`}>
    ...
    <div id={category.id} className="scroll-mt-28 mb-20">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <div className="flex items-center gap-4 bg-[#f3e8ff] p-1.5 rounded-full px-4 border border-purple-100 shadow-inner">
          <span className={`text-[13px] font-bold transition-colors ${!showAll ? 'text-[#6b21a8]' : 'text-slate-400'}`}>
          ...
          >
            <span className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow-sm transition-transform duration-300 ${showAll ? 'left-7' : 'left-1'}`} />
          </button>
          <span className={`text-[13px] font-bold transition-colors ${showAll ? 'text-[#6b21a8]' : 'text-slate-400'}`}>
  ...
  return (
    <div className="max-w-4xl mx-auto mt-16">
          ...
          <div key={idx} className={`flex flex-col md:flex-row w-full gap-8 transition-opacity duration-500 absolute left-0 px-8 md:px-12 ${idx === currentSlide ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
            ...
            <div className={`w-full md:w-2/3 flex flex-col border-slate-200 ${isRTL ? 'border-r pr-8 text-right' : 'border-l pl-8 text-left'}`}>
              ...
              <div className="mt-auto flex justify-between items-end">
                ...
                <button className="text-[#10b981] hover:text-[#059669] text-[14px] transition-colors font-medium">{t('territoryAdvantages.testimonials.readMore', 'read more...')}</button>
              </div>
            </div>
          </div>
        ))}
      ...
      <div className="flex items-center justify-center gap-6">
        <button onClick={() => setCurrentSlide((p) => (p === 0 ? 2 : p - 1))} className="text-[#10b981] hover:text-[#6b21a8] transition-colors focus:outline-none">
          <ChevronRight className={`w-8 h-8 ${isRTL ? '' : 'rotate-180'}`} />
        </button>
        <div className="flex gap-2">
          {testimonials.map((_, idx) => (
            <button key={idx} onClick={() => setCurrentSlide(idx)} className={`w-2.5 h-2.5 rounded-full transition-all focus:outline-none ${idx === currentSlide ? 'bg-[#6b21a8]' : 'bg-transparent border border-[#6b21a8]'}`} />
          ))}
        </div>
        <button onClick={() => setCurrentSlide((p) => (p === 2 ? 0 : p + 1))} className="text-[#10b981] hover:text-[#6b21a8] transition-colors focus:outline-none">
          <ChevronRight className={`w-8 h-8 ${isRTL ? 'rotate-180' : ''}`} />
        </button>
      </div>
    </div>
...
const SimpleFaqAccordion: React.FC<{ question: string; answer: React.ReactNode; isRTL: boolean }> = ({ question, answer, isRTL }) => {
  ...
  return (
    <div className="border-b border-slate-200 last:border-0 py-4 bg-white">
      ...
      <div className={`transition-all duration-300 ease-in-out overflow-hidden px-4 ${isOpen ? 'max-h-96 opacity-100 mt-4' : 'max-h-0 opacity-0'}`}>
...
export const TerritoryAdvantages: React.FC = () => {
  ...
  const COMPARISON_DATA: CompCategory[] = [
    { id: 'quality', title: t('territoryAdvantages.comparison.quality.title', 'Accuracy & quality'), items: [
      ...
      { feature: t('territoryAdvantages.comparison.quality.items.i3.feature'), bad: t('territoryAdvantages.comparison.quality.items.i3.bad'), good: t('territoryAdvantages.comparison.quality.items.i3.good'), desc: t('territoryAdvantages.comparison.quality.items.i3.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i4.feature'), bad: t('territoryAdvantages.comparison.quality.items.i4.bad'), good: t('territoryAdvantages.comparison.quality.items.i4.good'), desc: t('territoryAdvantages.comparison.quality.items.i4.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i5.feature'), bad: t('territoryAdvantages.comparison.quality.items.i5.bad'), good: t('territoryAdvantages.comparison.quality.items.i5.good'), desc: t('territoryAdvantages.comparison.quality.items.i5.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i6.feature'), bad: t('territoryAdvantages.comparison.quality.items.i6.bad'), good: t('territoryAdvantages.comparison.quality.items.i6.good'), desc: t('territoryAdvantages.comparison.quality.items.i6.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i7.feature'), bad: t('territoryAdvantages.comparison.quality.items.i7.bad'), good: t('territoryAdvantages.comparison.quality.items.i7.good'), desc: t('territoryAdvantages.comparison.quality.items.i7.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i8.feature'), bad: t('territoryAdvantages.comparison.quality.items.i8.bad'), good: t('territoryAdvantages.comparison.quality.items.i8.good'), desc: t('territoryAdvantages.comparison.quality.items.i8.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i9.feature'), bad: t('territoryAdvantages.comparison.quality.items.i9.bad'), good: t('territoryAdvantages.comparison.quality.items.i9.good'), desc: t('territoryAdvantages.comparison.quality.items.i9.desc') },
      { feature: t('territoryAdvantages.comparison.quality.items.i10.feature'), bad: t('territoryAdvantages.comparison.quality.items.i10.bad'), good: t('territoryAdvantages.comparison.quality.items.i10.good'), desc: t('territoryAdvantages.comparison.quality.items.i10.desc') }
    ]},
    { id: 'bereitstellung', title: t('territoryAdvantages.comparison.provision.title', 'Provision for users'), items: [
      { feature: t('territoryAdvantages.comparison.provision.items.i1.feature'), bad: t('territoryAdvantages.comparison.provision.items.i1.bad'), good: t('territoryAdvantages.comparison.provision.items.i1.good'), desc: t('territoryAdvantages.comparison.provision.items.i1.desc') },
      { feature: t('territoryAdvantages.comparison.provision.items.i2.feature'), bad: t('territoryAdvantages.comparison.provision.items.i2.bad'), good: t('territoryAdvantages.comparison.provision.items.i2.good'), desc: t('territoryAdvantages.comparison.provision.items.i2.desc') },
      { feature: t('territoryAdvantages.comparison.provision.items.i3.feature'), bad: t('territoryAdvantages.comparison.provision.items.i3.bad'), good: t('territoryAdvantages.comparison.provision.items.i3.good'), desc: t('territoryAdvantages.comparison.provision.items.i3.desc') },
      { feature: t('territoryAdvantages.comparison.provision.items.i4.feature'), bad: t('territoryAdvantages.comparison.provision.items.i4.bad'), good: t('territoryAdvantages.comparison.provision.items.i4.good'), desc: t('territoryAdvantages.comparison.provision.items.i4.desc') },
      { feature: t('territoryAdvantages.comparison.provision.items.i5.feature'), bad: t('territoryAdvantages.comparison.provision.items.i5.bad'), good: t('territoryAdvantages.comparison.provision.items.i5.good'), desc: t('territoryAdvantages.comparison.provision.items.i5.desc') }
    ]},
    { id: 'benutzerfreundlich', title: t('territoryAdvantages.comparison.userFriendliness.title', 'User friendliness'), items: [
      { feature: t('territoryAdvantages.comparison.userFriendliness.items.i1.feature'), bad: t('territoryAdvantages.comparison.userFriendliness.items.i1.bad'), good: t('territoryAdvantages.comparison.userFriendliness.items.i1.good'), desc: t('territoryAdvantages.comparison.userFriendliness.items.i1.desc') },
      { feature: t('territoryAdvantages.comparison.userFriendliness.items.i2.feature'), bad: t('territoryAdvantages.comparison.userFriendliness.items.i2.bad'), good: t('territoryAdvantages.comparison.userFriendliness.items.i2.good'), desc: t('territoryAdvantages.comparison.userFriendliness.items.i2.desc') },
      { feature: t('territoryAdvantages.comparison.userFriendliness.items.i3.feature'), bad: t('territoryAdvantages.comparison.userFriendliness.items.i3.bad'), good: t('territoryAdvantages.comparison.userFriendliness.items.i3.good'), desc: t('territoryAdvantages.comparison.userFriendliness.items.i3.desc') },
      { feature: t('territoryAdvantages.comparison.userFriendliness.items.i4.feature'), bad: t('territoryAdvantages.comparison.userFriendliness.items.i4.bad'), good: t('territoryAdvantages.comparison.userFriendliness.items.i4.good'), desc: t('territoryAdvantages.comparison.userFriendliness.items.i4.desc') },
      { feature: t('territoryAdvantages.comparison.userFriendliness.items.i5.feature'), bad: t('territoryAdvantages.comparison.userFriendliness.items.i5.bad'), good: t('territoryAdvantages.comparison.userFriendliness.items.i5.good'), desc: t('territoryAdvantages.comparison.userFriendliness.items.i5.desc') }
    ]},
    { id: 'optimierung', title: t('territoryAdvantages.comparison.optimization.title', 'Optimization capabilities'), items: [
      { feature: t('territoryAdvantages.comparison.optimization.items.i1.feature'), bad: t('territoryAdvantages.comparison.optimization.items.i1.bad'), good: t('territoryAdvantages.comparison.optimization.items.i1.good'), desc: t('territoryAdvantages.comparison.optimization.items.i1.desc') },
      { feature: t('territoryAdvantages.comparison.optimization.items.i2.feature'), bad: t('territoryAdvantages.comparison.optimization.items.i2.bad'), good: t('territoryAdvantages.comparison.optimization.items.i2.good'), desc: t('territoryAdvantages.comparison.optimization.items.i2.desc') },
      { feature: t('territoryAdvantages.comparison.optimization.items.i3.feature'), bad: t('territoryAdvantages.comparison.optimization.items.i3.bad'), good: t('territoryAdvantages.comparison.optimization.items.i3.good'), desc: t('territoryAdvantages.comparison.optimization.items.i3.desc') }
    ]}
  ];
  ...
  return (
    <div className={`min-h-screen bg-white font-sans text-slate-900 selection:bg-[#f3e8ff] selection:text-[#6b21a8] ${isRTL ? 'text-right' : 'text-left'}`}>
      ...
      <section className="bg-[#f3e8ff] py-20 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <FadeIn direction="up">
            <h3 className="text-3xl font-bold text-[#6b21a8] mb-4">{t('territoryAdvantages.resultsCta.title')}</h3>
            <p className="text-lg text-[#10b981] font-medium mb-8">{t('territoryAdvantages.resultsCta.desc')}</p>
            <a href="/territory-optimization" className="inline-block bg-[#6b21a8] text-white px-8 py-3.5 rounded font-medium hover:bg-[#581c87] transition-all shadow-md">
      ...
      <section className="py-24 bg-[#f8fafc] border-b border-slate-200 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-[#10b981] font-medium mb-12">{t('territoryAdvantages.testimonials.desc')}</p>
      ...
      <section className="py-24 bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg text-[#10b981] font-medium max-w-2xl mx-auto mb-16">{t('territoryAdvantages.pricing.desc')}</p>
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="bg-[#f3e8ff] p-10 rounded-xl shadow-sm border border-purple-100 flex flex-col items-center">
              ...
              <div className="text-2xl font-bold text-slate-800 mb-6">{t('territoryAdvantages.pricing.m3')}</div>
              <hr className="w-16 border-t-2 border-[#10b981] mb-6" />
              <p className="text-[#6b21a8] font-light mb-8 flex-grow">{t('territoryAdvantages.pricing.m3Desc')}</p>
            ...
            <div className="bg-[#6b21a8] p-10 rounded-xl shadow-md border border-[#6b21a8] flex flex-col items-center relative">
              <div className={`absolute top-0 ${isRTL ? 'left-0 rounded-br-lg rounded-tl-xl' : 'right-0 rounded-bl-lg rounded-tr-xl'} bg-[#10b981] text-white text-xs font-bold px-3 py-1`}>
                {t('territoryAdvantages.pricing.popular')}
              </div>
              <div className="text-6xl font-light text-white mb-2">12</div>
              <div className="text-2xl font-bold text-white mb-6">{t('territoryAdvantages.pricing.m12')}</div>
              <hr className="w-16 border-t-2 border-[#10b981] mb-6" />
              <p className="text-purple-100 font-light mb-8 flex-grow">{t('territoryAdvantages.pricing.m12Desc')}</p>
      ...
      <section className="bg-[#6b21a8] py-20 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-purple-100 text-lg font-light mb-10 max-w-2xl mx-auto">{t('territoryAdvantages.demoCta.desc')}</p>
          <div className="flex flex-wrap justify-center gap-6 mb-10">
            <span className="text-[#10b981] text-sm uppercase tracking-wider font-bold bg-white px-3 py-1 rounded-full">{t('territoryAdvantages.demoCta.f1')}</span>
            <span className="text-[#10b981] text-sm uppercase tracking-wider font-bold bg-white px-3 py-1 rounded-full">{t('territoryAdvantages.demoCta.f2')}</span>
            <span className="text-[#10b981] text-sm uppercase tracking-wider font-bold bg-white px-3 py-1 rounded-full">{t('territoryAdvantages.demoCta.f3')}</span>
          </div>
