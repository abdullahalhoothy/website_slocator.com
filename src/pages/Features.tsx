  ...
  const leftColumnFeatures = [
    {
      ...
      items: [
        {text: t('features_page.checklist.c1.i1'), info: true}, {text: t('features_page.checklist.c1.i2'), info: true},
        {text: t('features_page.checklist.c1.i3'), info: true}, {text: t('features_page.checklist.c1.i4'), info: true},
        {text: t('features_page.checklist.c1.i5'), info: true}, {text: t('features_page.checklist.c1.i6'), info: true},
        {text: t('features_page.checklist.c1.i7'), info: true}, {text: t('features_page.checklist.c1.i8'), info: true, val: "< 10 Sec."},
        {text: t('features_page.checklist.c1.i9'), info: true, val: "16 weeks"}, {text: t('features_page.checklist.c1.i10'), info: true, val: "125"},
        {text: t('features_page.checklist.c1.i11'), info: true}, {text: t('features_page.checklist.c1.i12'), info: true}, {text: t('features_page.checklist.c1.i13'), info: true},
        {text: t('features_page.checklist.c1.i14'), info: true}, {text: t('features_page.checklist.c1.i15'), info: true}, {text: t('features_page.checklist.c1.i16'), info: true},
        {text: t('features_page.checklist.c1.i17'), info: true}, {text: t('features_page.checklist.c1.i18'), info: true}, {text: t('features_page.checklist.c1.i19'), info: true},
        {text: t('features_page.checklist.c1.i20'), info: true}, {text: t('features_page.checklist.c1.i21'), info: true}, {text: t('features_page.checklist.c1.i22'), info: true},
        {text: t('features_page.checklist.c1.i23'), info: true}, {text: t('features_page.checklist.c1.i24'), info: true},
        {text: t('features_page.checklist.c1.i25'), info: true}, {text: t('features_page.checklist.c1.i26'), info: true},
        {text: t('features_page.checklist.c1.i27'), info: true}, {text: t('features_page.checklist.c1.i28'), info: true},
        {text: t('features_page.checklist.c1.i29'), info: true}, {text: t('features_page.checklist.c1.i30'), info: true},
        {text: t('features_page.checklist.c1.i31'), info: true}, {text: t('features_page.checklist.c1.i32'), info: true},
        {text: t('features_page.checklist.c1.i33'), info: true}, {text: t('features_page.checklist.c1.i34'), info: true},
        {text: t('features_page.checklist.c1.i35'), info: true}, {text: t('features_page.checklist.c1.i36'), info: true}
      ]
    },
    {
      title: t('features_page.checklist.c2.title'),
      items: [
        {text: t('features_page.checklist.c2.i1'), info: true}, {text: t('features_page.checklist.c2.i2'), info: true}, {text: t('features_page.checklist.c2.i3'), info: true},
        {text: t('features_page.checklist.c2.i4'), info: true}, {text: t('features_page.checklist.c2.i5'), info: true}, {text: t('features_page.checklist.c2.i6'), info: true}
      ]
    },
    {
      title: t('features_page.checklist.c3.title'),
      items: [
        {text: t('features_page.checklist.c3.i1'), info: true}, {text: t('features_page.checklist.c3.i2'), info: true}, {text: t('features_page.checklist.c3.i3'), info: true},
        {text: t('features_page.checklist.c3.i4'), info: true}, {text: t('features_page.checklist.c3.i5'), info: true}, {text: t('features_page.checklist.c3.i6'), info: true},
        {text: t('features_page.checklist.c3.i7'), info: true}, {text: t('features_page.checklist.c3.i8'), info: true},
        {text: t('features_page.checklist.c3.i9'), info: true}, {text: t('features_page.checklist.c3.i10'), info: true},
        {text: t('features_page.checklist.c3.i11'), info: true}, {text: t('features_page.checklist.c3.i12'), info: true}
      ]
    },
    {
      title: t('features_page.checklist.c4.title'),
      items: [
        {text: t('features_page.checklist.c4.i1'), info: true, val: "3000"}, {text: t('features_page.checklist.c4.i2'), info: true},
        {text: t('features_page.checklist.c4.i3'), isSub: true}, {text: t('features_page.checklist.c4.i4'), isSub: true},
        {text: t('features_page.checklist.c4.i5'), isSub: true}, {text: t('features_page.checklist.c4.i6'), info: true},
        {text: t('features_page.checklist.c4.i7'), info: true}, {text: t('features_page.checklist.c4.i8'), info: true},
        {text: t('features_page.checklist.c4.i9'), info: true}, {text: t('features_page.checklist.c4.i10'), info: true},
        {text: t('features_page.checklist.c4.i11'), info: true}, {text: t('features_page.checklist.c4.i12'), info: true},
        {text: t('features_page.checklist.c4.i13'), info: true}, {text: t('features_page.checklist.c4.i14'), info: true},
        {text: t('features_page.checklist.c4.i15'), info: true}, {text: t('features_page.checklist.c4.i16'), info: true},
        {text: t('features_page.checklist.c4.i17'), info: true}, {text: t('features_page.checklist.c4.i18'), info: true},
        {text: t('features_page.checklist.c4.i19'), info: true}, {text: t('features_page.checklist.c4.i20'), info: true},
        {text: t('features_page.checklist.c4.i21'), info: true}, {text: t('features_page.checklist.c4.i22'), info: true},
        {text: t('features_page.checklist.c4.i23'), info: true}, {text: t('features_page.checklist.c4.i24'), info: true}
      ]
    }
  ];
  ...
  const rightColumnFeatures = [
    {
      ...
      items: [
        {text: t('features_page.checklist.c5.i1')}, {text: t('features_page.checklist.c5.i2'), isSub: true}, {text: t('features_page.checklist.c5.i3'), isSub: true},
        {text: t('features_page.checklist.c5.i4')}, {text: t('features_page.checklist.c5.i5')}, {text: t('features_page.checklist.c5.i6')},
        {text: t('features_page.checklist.c5.i7'), info: true}, {text: t('features_page.checklist.c5.i8')},
        {text: t('features_page.checklist.c5.i9')}, {text: t('features_page.checklist.c5.i10'), info: true},
        {text: t('features_page.checklist.c5.i11')}, {text: t('features_page.checklist.c5.i12')},
    ...
    },
    {
      ...
      items: [
        {text: t('features_page.checklist.c6.i1'), info: true}, {text: t('features_page.checklist.c6.i2'), isSub: true}, {text: t('features_page.checklist.c6.i3'), isSub: true},
        {text: t('features_page.checklist.c6.i4'), isSub: true}, {text: t('features_page.checklist.c6.i5'), isSub: true}, {text: t('features_page.checklist.c6.i6'), isSub: true}, {text: t('features_page.checklist.c6.i7'), isSub: true},
        {text: t('features_page.checklist.c6.i8'), info: true}, {text: t('features_page.checklist.c6.i9'), isSub: true}, {text: t('features_page.checklist.c6.i10'), isSub: true},
        {text: t('features_page.checklist.c6.i11'), isSub: true}, {text: t('features_page.checklist.c6.i12'), isSub: true},
        {text: t('features_page.checklist.c6.i13'), isSub: true}, {text: t('features_page.checklist.c6.i14'), isSub: true}
      ]
    },
    {
      title: t('features_page.checklist.c7.title'),
      items: [
        {text: t('features_page.checklist.c7.i1'), info: true, val: "30 Days"}, {text: t('features_page.checklist.c7.i2'), info: true},
        {text: t('features_page.checklist.c7.i3'), info: true}, {text: t('features_page.checklist.c7.i4'), info: true},
        {text: t('features_page.checklist.c7.i5'), info: true}, {text: t('features_page.checklist.c7.i6'), info: true}
      ]
    },
    {
      title: t('features_page.checklist.c8.title'),
      items: [
        {text: t('features_page.checklist.c8.i1'), info: true}, {text: t('features_page.checklist.c8.i2'), info: true},
        {text: t('features_page.checklist.c8.i3'), info: true}, {text: t('features_page.checklist.c8.i4'), info: true},
        {text: t('features_page.checklist.c8.i5'), info: true}, {text: t('features_page.checklist.c8.i6'), info: true},
        {text: t('features_page.checklist.c8.i7'), info: true}, {text: t('features_page.checklist.c8.i8'), info: true},
        {text: t('features_page.checklist.c8.i9'), info: true}, {text: t('features_page.checklist.c8.i10'), info: true}
      ]
    },
    {
      title: t('features_page.checklist.c9.title'),
      items: [
        {text: t('features_page.checklist.c9.i1'), info: true}, {text: t('features_page.checklist.c9.i2')},
        {text: t('features_page.checklist.c9.i3'), isSub: true}, {text: t('features_page.checklist.c9.i4'), isSub: true},
        {text: t('features_page.checklist.c9.i5'), isSub: true}, {text: t('features_page.checklist.c9.i6'), isSub: true},
        {text: t('features_page.checklist.c9.i7'), info: true}, {text: t('features_page.checklist.c9.i8'), info: true},
        {text: t('features_page.checklist.c9.i9'), info: true}, {text: t('features_page.checklist.c9.i10'), info: true},
        {text: t('features_page.checklist.c9.i11'), info: true}, {text: t('features_page.checklist.c9.i12'), info: true}
      ]
    },
    {
      title: t('features_page.checklist.c10.title'),
      items: [
        {text: t('features_page.checklist.c10.i1'), info: true}, {text: t('features_page.checklist.c10.i2'), info: true},
        {text: t('features_page.checklist.c10.i3'), isSub: true, info: true}, {text: t('features_page.checklist.c10.i4'), isSub: true, info: true},
        {text: t('features_page.checklist.c10.i5'), isSub: true, info: true}, {text: t('features_page.checklist.c10.i6'), isSub: true},
        {text: t('features_page.checklist.c10.i7'), isSub: true}, {text: t('features_page.checklist.c10.i8'), info: true},
        {text: t('features_page.checklist.c10.i9')}, {text: t('features_page.checklist.c10.i10'), isSub: true}, {text: t('features_page.checklist.c10.i11'), isSub: true},
        {text: t('features_page.checklist.c10.i12'), isSub: true}, {text: t('features_page.checklist.c10.i13'), isSub: true}
      ]
    }
  ];
  ...
  return (
    <div className={`min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 selection:text-[#00609c] ${isRTL ? 'text-right' : 'text-left'}`}>
      ...
      <FeatureBlock 
        ...
        ctaText={t('srp.integrations.cta')} ctaLink="/integrations"
      />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              <FadeIn direction={isRTL ? 'right' : 'left'}>
                ...
                <ul className="flex flex-col gap-4 mt-6">
                  {(t('features_page.blocks.b10.bullets', { returnObjects: true }) as string[]).map((bullet, i) => (
                    <li key={i} className="flex items-start gap-3 text-slate-600 font-light text-[16px]">
                      <CheckCircle2 className="w-5 h-5 text-[#00609c] shrink-0 mt-0.5" />
                      <span className="leading-relaxed">{bullet}</span>
                    </li>
      ...
      <section className="py-24 bg-[#eef4f8] border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-7xl">
          <FadeIn direction="up">
            <h2 className="text-3xl lg:text-[44px] font-medium text-slate-800 text-center mb-16">{t('features_page.listTitle')}</h2>
          </FadeIn>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <FadeIn direction="up">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-medium text-slate-800 mb-4">{t('contactPage.hero.title')}</h2>
              ...
              <div className="bg-white p-10 rounded shadow-sm border border-slate-100 text-center flex flex-col items-center">
                ...
                <div className="flex flex-col gap-4 text-[#00609c] font-light text-[15px] items-start w-full max-w-xs mx-auto">
                  ...
                  <div className="flex items-center gap-3 mt-2 text-slate-600">
                    <MonitorSmartphone className="w-5 h-5 text-[#6699b8]" /> {t('contactPage.support.teamviewer', 'Teamviewer: Remote access for S-Locator Support')}
                  </div>
                </div>
              </div>
            </FadeIn>
