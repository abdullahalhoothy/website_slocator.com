...
const NumberInput: React.FC<NumberInputProps> = ({ value, setter, min = 0, max = 100 }) => (
  <div className="flex flex-col border border-slate-300 rounded overflow-hidden w-16">
    <button
      ...
      className="bg-slate-100 hover:bg-slate-200 h-5 flex items-center justify-center border-b border-slate-300"
    >
    ...
    <input
      ...
      value={value}
      readOnly
      className="w-full text-center h-8 font-bold text-[#8A2BE2] outline-none"
      dir="ltr"
    />
    <button
      onClick={() => setter(Math.max(min, value - 1))}
      className="bg-slate-100 hover:bg-slate-200 h-5 flex items-center justify-center border-t border-slate-300"
    >
    ...
    >
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <FadeIn direction="up">
            <h1 className="text-3xl lg:text-4xl font-bold text-slate-800 mb-8 tracking-tight">
              {t(
                'roiCalculator.hero.title',
                'حاسبة العائد على الاستثمار (ROI) لخدمات المبيعات الميدانية',
              )}
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 text-lg text-slate-600 font-medium">
              ...
              <label className="flex items-center gap-2 cursor-pointer hover:text-[#8A2BE2] transition-colors">
                <input
                  type="checkbox"
                  defaultChecked
                  className="w-5 h-5 accent-[#8A2BE2] rounded cursor-pointer"
                />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <FadeIn direction="up">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-10 border-b border-slate-100 pb-8">
              ...
              <div className="flex-1 w-full">
                <h4 className="font-bold text-slate-800 mb-4">
                  {t('roiCalculator.form.industry', 'الصناعة')}
                </h4>
                <select
                  className={`w-full md:w-1/3 p-3 border border-slate-300 rounded-lg outline-none focus:border-[#8A2BE2] bg-slate-50 focus:bg-white transition-colors cursor-pointer ${isRTL ? 'text-right' : 'text-left'}`}
                >
                  <option value="" disabled selected>
                    {t('roiCalculator.form.selectIndustry', 'اختر الصناعة')}
                  </option>
                  <option value="consumer">
                    {t('roiCalculator.form.indConsumer', 'السلع الاستهلاكية')}
                  </option>
                  <option value="industry">
                    {t('roiCalculator.form.indIndustry', 'الصناعة والبناء')}
                  </option>
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-slate-800 mb-6">
                  {t('roiCalculator.form.fieldSales', 'قوة المبيعات الميدانية')}
                </h4>

                {/* Row 1 inputs */}
                <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-slate-500 mb-1 border-b-2 border-dotted border-slate-300 pb-1">
                      {t('roiCalculator.form.persons', 'الأشخاص')}
                    </label>
                    <input
                      type="number"
                      value={persons}
                      ...
                      dir="ltr"
                      className="p-2.5 border border-slate-300 rounded outline-none focus:border-[#8A2BE2] focus:ring-1 focus:ring-[#8A2BE2]/30 transition-all font-medium text-center"
                    />
                  </div>
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-slate-500 mb-1 border-b-2 border-dotted border-slate-300 pb-1">
                      {t('roiCalculator.form.distance', 'المسافة (كم)')}
                    </label>
                    <div
                      className="flex items-center border border-slate-300 rounded overflow-hidden focus-within:border-[#8A2BE2] focus-within:ring-1 focus-within:ring-[#8A2BE2]/30 transition-all bg-white"
                      dir="ltr"
                    >
                      <input
                        type="number"
                        ...
                        className="p-2.5 w-full outline-none font-medium text-center"
                      />
                      <span className="bg-slate-50 px-3 text-xs text-slate-500 whitespace-nowrap border-l border-slate-300 h-full flex items-center font-medium">
                        {t('roiCalculator.form.perYear', 'سنوياً')}
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-slate-500 mb-1 border-b-2 border-dotted border-slate-300 pb-1">
                      {t('roiCalculator.form.planningHours', 'ساعات التخطيط')}
                    </label>
                    <div
                      className="flex items-center border border-slate-300 rounded overflow-hidden focus-within:border-[#8A2BE2] focus-within:ring-1 focus-within:ring-[#8A2BE2]/30 transition-all bg-white"
                      dir="ltr"
                    >
                      ...
                      />
                      <span className="bg-slate-50 px-3 text-xs text-slate-500 whitespace-nowrap border-l border-slate-300 h-full flex items-center font-medium">
                        {t('roiCalculator.form.perWeek', 'أسبوعياً')}
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-slate-500 mb-1 border-b-2 border-dotted border-slate-300 pb-1">
                      {t('roiCalculator.form.salary', 'الراتب الإجمالي')}
                    </label>
                    <div
                      className="flex items-center border border-slate-300 rounded overflow-hidden focus-within:border-[#8A2BE2] focus-within:ring-1 focus-within:ring-[#8A2BE2]/30 transition-all bg-white"
                      dir="ltr"
                  ...
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-slate-500 mb-1 border-b-2 border-dotted border-slate-300 pb-1">
                      {t('roiCalculator.form.turnover', 'حجم المبيعات')}
                    </label>
                    <div
                      className="flex items-center border border-slate-300 rounded overflow-hidden focus-within:border-[#8A2BE2] focus-within:ring-1 focus-within:ring-[#8A2BE2]/30 transition-all bg-white"
                      dir="ltr"
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mt-6">
                  <div className="flex flex-col">
                    <label className="text-sm font-medium text-slate-500 mb-1 border-b-2 border-dotted border-slate-300 pb-1">
                      {t('roiCalculator.form.workHours', 'ساعات العمل')}
                    </label>
                    <div
                      className="flex items-center border border-slate-300 rounded overflow-hidden focus-within:border-[#8A2BE2] focus-within:ring-1 focus-within:ring-[#8A2BE2]/30 transition-all bg-white"
                      dir="ltr"
            ...
            <div className="md:ml-12 md:mr-12 mt-8 p-6 bg-slate-50 rounded-xl border border-slate-200 flex flex-col md:flex-row flex-wrap items-start md:items-center gap-6 text-sm">
              <div className="flex flex-col">
                <label className="text-slate-500 mb-1 font-medium">
                  {t('roiCalculator.form.advanced.vehCost', 'تكاليف المركبة')}
                </label>
                <div className="flex gap-2 items-center text-slate-500" dir="ltr">
                  <span className="text-slate-800 font-bold">{vehCostPerKm}</span>{' '}
                  {t('roiCalculator.form.advanced.perKm', 'لكل كم')}
                </div>
              </div>
              <div className="flex flex-col">
                <label className="text-slate-500 mb-1 font-medium">
                  {t('roiCalculator.form.advanced.empFactor', 'عامل تكلفة صاحب العمل')}
                </label>
                <div className="flex gap-2 items-center text-slate-500" dir="ltr">
                  <span className="text-slate-800 font-bold">{empFactor}</span>
                </div>
              </div>
              <div
                className={`${isRTL ? 'md:mr-auto' : 'md:ml-auto'} flex items-center gap-6 mt-4 md:mt-0 w-full md:w-auto justify-between md:justify-end`}
              >
                <button className="text-[#8A2BE2] hover:text-[#6b21a8] font-bold underline transition-colors">
                  {t('roiCalculator.form.advanced.edit', 'تعديل')}
                </button>
                <button
                  onClick={handleReset}
                  className="text-slate-500 hover:text-slate-800 font-bold flex items-center gap-2 bg-white px-4 py-2 rounded shadow-sm border border-slate-200 transition-all"
                >
                  <RefreshCw className="w-4 h-4" />{' '}
                  {t('roiCalculator.form.advanced.reset', 'إعادة ضبط')}
                </button>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-16 bg-[#f8fafc] border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex font-bold text-lg text-slate-800 mb-6 px-6">
            ...
            <div className="w-[22%] text-center text-slate-500 font-normal hidden md:block">
              {t('roiCalculator.results.initial', 'وضعك الأولي')}
            </div>
            <div className="w-auto flex-1 text-center text-[#8A2BE2]">
              {t('roiCalculator.results.advantage', 'ميزتك مع S-Locator')}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 mb-6 overflow-hidden hover:shadow-md transition-shadow">
            <div className="flex flex-col md:flex-row items-center p-6 gap-6 md:gap-0">
              <div className="w-full md:w-1/3 font-bold text-xl text-slate-800">
                {t('roiCalculator.results.vehCosts', 'تكاليف المركبة')}
              </div>
              <div
                className="w-full md:w-[22%] text-center text-3xl font-light text-slate-600"
                dir="ltr"
              >
                {formatCurrency(initialVehCost)}
              </div>
              <div className="w-full md:w-auto flex-1 flex flex-col sm:flex-row items-center justify-center gap-4">
                <div
                  className="flex items-center gap-2 text-[#8A2BE2] font-bold text-xl bg-[#f5f3ff] px-4 py-2 rounded-lg border border-purple-100 shadow-inner"
                  dir="ltr"
                >
                ...
                <span className="text-3xl font-bold text-[#489E46]" dir="ltr">
                  -{formatCurrency(vehSaved)}
                </span>
              </div>
              <div
                className={`w-full md:w-[15%] flex justify-center ${isRTL ? 'md:justify-start' : 'md:justify-end'}`}
              >
                <button
                  onClick={() => toggleRow('veh')}
                  className="text-[#8A2BE2] flex items-center gap-1 font-bold hover:text-[#6b21a8] transition-colors bg-purple-50 px-3 py-1.5 rounded-lg"
                >
                  <span>
                    {expandedRow === 'veh'
                      ? t('roiCalculator.results.fewerDetails', 'تفاصيل أقل')
                      : t('roiCalculator.results.moreDetails', 'تفاصيل أكثر')}
                  </span>
                  {expandedRow === 'veh' ? (
            ...
            {expandedRow === 'veh' && (
              <div
                className={`bg-slate-50 p-6 md:p-8 border-t border-slate-100 flex flex-col md:flex-row ${isRTL ? 'justify-start' : 'justify-end'}`}
              >
                  ...
                  <div className="flex-1 flex flex-col gap-3 w-full">
                    ...
                    <div className="flex justify-between text-slate-600 pt-2 font-medium">
                      ...
                      <span className="font-bold text-lg" dir="ltr">
                        {new Intl.NumberFormat('en-US').format(kmSaved)}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 mb-6 overflow-hidden hover:shadow-md transition-shadow">
            <div className="flex flex-col md:flex-row items-center p-6 gap-6 md:gap-0">
              <div className="w-full md:w-1/3 font-bold text-xl text-slate-800">
                {t('roiCalculator.results.planCosts', 'تكاليف التخطيط')}
              </div>
              <div
                className="w-full md:w-[22%] text-center text-3xl font-light text-slate-600"
                dir="ltr"
              >
                {formatCurrency(initialPlanCost)}
              </div>
              <div className="w-full md:w-auto flex-1 flex flex-col sm:flex-row items-center justify-center gap-4">
                <div
                  className="flex items-center gap-2 text-[#8A2BE2] font-bold text-xl bg-[#f5f3ff] px-4 py-2 rounded-lg border border-purple-100 shadow-inner"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow">
            <div className="flex flex-col md:flex-row items-center p-6 gap-6 md:gap-0">
              <div className="w-full md:w-1/3 font-bold text-xl text-slate-800">
                {t('roiCalculator.results.salesPot', 'إمكانات المبيعات')}
              </div>
              <div
                className="w-full md:w-[22%] text-center text-3xl font-light text-slate-600"
                dir="ltr"
              >
                {formatCurrency(initialRev)}
              </div>
              <div className="w-full md:w-auto flex-1 flex flex-col sm:flex-row items-center justify-center gap-4">
                <div
                  className="flex items-center gap-2 text-[#8A2BE2] font-bold text-xl bg-[#f5f3ff] px-4 py-2 rounded-lg border border-purple-100 shadow-inner"
                ...
                <span className="text-slate-400 font-bold text-2xl hidden sm:block">=</span>
                <span className="text-3xl font-bold text-[#8A2BE2]" dir="ltr">
                  +{formatCurrency(revAdded)}
                </span>
              </div>
              <div
                className={`w-full md:w-[15%] flex justify-center ${isRTL ? 'md:justify-start' : 'md:justify-end'}`}
              ...
              >
                <div className="w-full md:w-3/4 flex flex-col md:flex-row gap-8 items-start">
                  <div className="flex-1 flex flex-col gap-3 w-full">
                    <div className="flex justify-between font-bold text-slate-800 border-b border-slate-200 pb-3 text-lg">
                      <span>
                        {t('roiCalculator.results.annualSales', 'إمكانات المبيعات السنوية')}
                      </span>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          <FadeIn direction="up">
            ...
            <div
              className={`w-full h-[300px] mb-16 relative border-b-2 border-slate-200 mt-12 mx-4 sm:mx-0 ${isRTL ? 'border-r-2' : 'border-l-2'}`}
            >
              {/* Grid Lines */}
              ...
              >
                <polyline
                  points="0,95 25,80 50,50 75,25 100,5"
                  fill="none"
                  stroke="#8A2BE2"
                  strokeWidth="2.5"
              ...
              {chartPointsData.map(pt => (
                <div
                  key={pt.id}
                  className="absolute -bottom-10 text-sm text-slate-500 font-bold bg-white px-2 transform -translate-x-1/2"
                  style={{ [isRTL ? 'right' : 'left']: `${pt.x}%` }}
                >
                  {pt.label}
                </div>
              ))}
              ...
              <div
                className={`absolute bottom-[160px] transform -translate-x-1/2 bg-slate-500 text-white text-xs font-bold px-3 py-1.5 rounded shadow-md pointer-events-none z-0 hidden sm:block ${isRTL ? 'right-[40%]' : 'left-[40%]'}`}
              >
              ...
              {chartPointsData.map(pt => (
                ...
                >
                  ...
                  {hoveredChartPoint === pt.id && (
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 w-[280px] bg-white border border-slate-200 shadow-xl rounded-xl p-5 z-50 pointer-events-none">
                      <h4 className="font-bold text-slate-800 mb-4 text-[15px] border-b border-slate-100 pb-2">
                        {t('roiCalculator.chart.afterMonths', 'بعد')} {pt.months}{' '}
                        {t('roiCalculator.chart.months', 'أشهر:')}
                      </h4>
                  ...
                  {hoveredChartPoint !== pt.id && (
                    <div
                      className={`absolute -top-8 left-1/2 transform -translate-x-1/2 bg-white border ${pt.total < 0 ? 'border-slate-300 text-slate-500' : 'border-[#489E46] text-[#489E46]'} text-xs font-bold px-2 py-1 rounded shadow-sm whitespace-nowrap pointer-events-none`}
                      dir="ltr"
                    >
                      {formatCurrency(pt.total)}
                    </div>
            ...
            <div className="mt-20 max-w-4xl mx-auto text-center md:text-left">
              <h2
                className={`text-3xl lg:text-5xl font-bold text-slate-800 mb-8 leading-tight ${isRTL ? 'text-center md:text-right' : 'text-center md:text-left'}`}
              >
                <span dir="ltr">{formatCurrency(revAdded)}</span>{' '}
                <span className="font-light text-slate-600">
                  {t('roiCalculator.summary.additionalSales', 'إمكانات مبيعات إضافية')}
                </span>
              </h2>
              <p
                className={`text-slate-600 text-lg md:text-xl leading-relaxed mb-6 font-light ${isRTL ? 'text-center md:text-right' : 'text-center md:text-left'}`}
              >
                {t(
                  'roiCalculator.summary.desc1',
                  'المصاريف السنوية لـ S-Locator بالإضافة إلى تكاليف بدء المشروع لمرة واحدة يتم تغطيتها من خلال توفير تكاليف المركبة وحدها.',
                )}
              </p>
              <p
                className={`text-slate-600 text-lg md:text-xl leading-relaxed mb-10 font-light ${isRTL ? 'text-center md:text-right' : 'text-center md:text-left'}`}
              >
                {t(
                  'roiCalculator.summary.desc2',
                  'في معظم الحالات، يمكن إعادة توزيع المناطق الشاغرة وتحسينها من خلال تحسين المناطق وتخطيط المسارات. الاستبدال ليس ضرورياً دائماً، ولكن يتم الحفاظ على جودة الزيارات أو زيادتها.',
                )}
              </p>
              <div className="bg-[#f5f3ff] p-6 rounded-xl border border-purple-100 inline-block mb-10 w-full text-center">
                <p className="text-xl font-bold text-slate-800">
                  {t(
                    'roiCalculator.summary.breakEven',
                    'أنت ترى عائداً إيجابياً على الاستثمار. يمكنك الوصول لنقطة التعادل خلال',
                  )}{' '}
                  <span className="text-[#489E46] text-2xl mx-1">{breakEvenMonths}</span>{' '}
                  {t('roiCalculator.summary.months', 'أشهر.')}
                </p>
              </div>

              <div
                className={`flex justify-center ${isRTL ? 'md:justify-end' : 'md:justify-start'}`}
              >
                <a
                  href="/contact"
                  className="inline-block bg-[#8A2BE2] text-white px-12 py-4 rounded font-bold hover:bg-[#6b21a8] transition-colors shadow-xl text-lg"
                >
              ...
              <p
                className={`text-xs text-slate-400 font-light border-t border-slate-100 pt-8 mt-12 text-center ${isRTL ? 'md:text-right' : 'md:text-left'}`}
              >
                {t(
                  'roiCalculator.summary.disclaimer',
                  '* الأرقام المقدمة هي قيم متوسطة من مشاريع عملاء متعددة ومتنوعة. قد تختلف مسافاتك.',
                )}
              </p>
            </div>
          </FadeIn>
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-4xl">
          <FadeIn direction="up">
            ...
            <p className="text-green-50 text-xl font-light mb-12 max-w-3xl mx-auto leading-relaxed">
              {t(
                'roiCalculator.cta.desc',
                'اتخذ الخطوة الأولى نحو مسارات أكثر كفاءة، ومناطق محسنة، والمزيد من مكالمات العملاء، وعائد استثمار قابل للقياس مع S-Locator.',
              )}
            </p>
      ...
      <section className="py-24 bg-[#f8fafc] border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <FadeIn direction="up">
            <h2 className="text-3xl lg:text-[40px] font-bold text-slate-800 mb-16">
              {t('roiCalculator.faqs.title', 'الأسئلة الشائعة')}
            </h2>
            <div className="grid md:grid-cols-2 gap-x-16 gap-y-6 max-w-5xl mx-auto">
              {faqs.map((q, i) => (
                <a
                  key={i}
                  href="/faq"
                  className={`text-[17px] font-medium text-[#8A2BE2] hover:text-[#489E46] transition-colors py-3 border-b border-slate-200 leading-snug block ${isRTL ? 'text-right' : 'text-left'}`}
                >
                  {q}
                </a>
              ))}
      ...
      <section className="bg-white py-24 text-center">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mt-6 text-[15px] text-slate-500 font-light flex items-center justify-center gap-2">
            ...
            {t('contactPage.hero.availability', 'متاحون عبر الهاتف من الاثنين إلى الجمعة')}
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto mt-16 mb-20">
            <div className="flex-1 bg-[#f8fafc] p-10 rounded-2xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              <h3 className="text-[17px] font-medium text-slate-500 mb-2">
                {t('contactPage.support.pretitle', 'أنا مستخدم بالفعل وأحتاج إلى')}
              </h3>
              <h4 className="text-[32px] font-bold text-slate-800 mb-8">
                {t('contactPage.support.title', 'الدعم الفني')}
              </h4>
            ...
            <div className="flex-1 bg-[#f8fafc] p-10 rounded-2xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              <h3 className="text-[17px] font-medium text-slate-500 mb-2">
                {t('contactPage.sales.pretitle', 'أنا مهتم وأرغب في')}
              </h3>
              <h4 className="text-[32px] font-bold text-slate-800 mb-8">
                {t('contactPage.sales.title', 'استشارة للشراء')}
              </h4>
          ...
          <div className="pt-16 border-t border-slate-200">
            <h3 className="text-3xl font-bold text-[#8A2BE2] mb-16">
              {t('contactPage.team.title', 'نتطلع إلى محادثتك')}
            </h3>
            <div
                ...
                >
                  ...
                  >
                    <img
                      ...
                      onError={e => {
                        e.currentTarget.src =
                          'https://via.placeholder.com/150/f5f3ff/8A2BE2?text=User'
                      }}
                    />
                  </div>
