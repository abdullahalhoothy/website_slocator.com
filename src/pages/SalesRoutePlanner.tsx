...
const FaqAccordion: React.FC<{ question: string; answer: React.ReactNode }> = ({
  question,
  answer,
}) => {
...
export const SalesRoutePlanner: React.FC = () => {
  ...
  const FEATURES_DATA = [
    {
      id: 1,
      title: t(
        'srp.features.f1.title',
        'Keep track of cash cows and hot leads on your customer map',
      ),
      description: t(
        'srp.features.f1.desc',
        'As a sales rep, is it a challenge to get an accurate overview of your territory? And to know where to focus your energy? S-Locator is the best sales route planner software for you to:',
      ),
      bullets: [
        t(
          'srp.features.f1.b1',
          'Identify current opportunities by using color-coded maps and filters (like ABC categories)',
        ),
    ...
    },
    {
      id: 2,
      title: t(
        'srp.features.f2.title',
        '(Re)schedule any time and achieve up to 25% more customer visits',
      ),
      description: t(
        'srp.features.f2.desc',
        'Outside sales are dynamic - it stands to reason that a dynamic sales route planner app is the tool you need to get a leg up. S-Locator brings order to the chaos of inevitable rescheduling of stops.',
      ),
      bullets: [
        t(
          'srp.features.f2.b1',
          'Appointment cancelled? Generate an updated schedule in seconds to accommodate your current circumstances',
        ),
        t(
          'srp.features.f2.b2',
          'Update your schedule whenever necessary to ensure maximum efficiency',
        ),
        t(
          'srp.features.f2.b3',
          "A visit's urgency, specific business hours, and a host of other factors can all be taken into account",
        ),
      ],
    ...
    },
    {
      ...
      description: t(
        'srp.features.f3.desc',
        'Do you find prioritizing your customers tricky? Are you tired of constantly having to put out fires? The S-Locator sales route planner app will ensure you get a grip on all the moving parts in your territory.',
      ),
      bullets: [
        t(
          'srp.features.f3.b1',
          'Be free of worry and stress over when to plan the next visit - let S-Locator keep track and act on your behalf',
        ),
        t('srp.features.f3.b2', 'Accounts due for a visit automatically appear in your schedule'),
        t(
          'srp.features.f3.b3',
          "Adapt clients' intervals at any time so you can follow up at the right moment",
        ),
      ],
  ...
  const TESTIMONIALS = [
    {
      text: t('srp.testimonials.t1.text'),
      author: t('srp.testimonials.t1.author'),
      role: t('srp.testimonials.t1.role'),
      logo: '/assets/images/logo-sonax.webp',
      image: '/assets/images/florianbehmer-rund.webp',
    },
    {
      text: t('srp.testimonials.t2.text'),
      author: t('srp.testimonials.t2.author'),
      role: t('srp.testimonials.t2.role'),
      logo: '/assets/images/samsung.webp',
      image: '/assets/images/bolliger.webp',
    },
    {
      text: t('srp.testimonials.t3.text'),
      author: t('srp.testimonials.t3.author'),
      role: t('srp.testimonials.t3.role'),
      logo: '/assets/images/trupanion.webp',
      image: '/assets/images/trupanion.webp',
    },
    {
      text: t('srp.testimonials.t4.text'),
      author: t('srp.testimonials.t4.author'),
      role: t('srp.testimonials.t4.role'),
      logo: '/assets/images/wuerth-group.webp',
      image: '/assets/images/florianbehmer-rund.webp',
    },
  ]
    ...
    >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full lg:w-1/2 flex justify-center order-2 lg:order-1">
              <FadeIn direction={isRTL ? 'right' : 'left'}>
                <img
                  src="/assets/images/ill-sales-route-planner-md-xl-en.webp"
                  alt="Sales Route Planner"
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6 order-1 lg:order-2">
              <FadeIn direction="up">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100 w-fit">
                  ...
                  <span className="text-[11px] font-bold text-[#00609c] uppercase tracking-widest">
                    {t('srp.hero.badge', 'Route Planner')}
                  </span>
                </div>
                <h1 className="text-4xl lg:text-5xl font-medium text-slate-900 leading-[1.2] mt-4">
                  ...
                  <span className="font-light text-slate-600">
                    {t('srp.hero.subtitle', 'capture more time to generate sales')}
                  </span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  <a
                    href="/get-started"
                    className="bg-[#44E559] hover:bg-[#3bc24d] text-slate-900 px-8 py-4 rounded font-medium flex items-center justify-center gap-2 transition-all shadow-md"
                  >
                    {t('srp.hero.cta', 'Start 30-day free trial*')}
                  </a>
                  <a
                    href="#video"
                    className="bg-white border border-slate-300 text-slate-700 px-8 py-4 rounded font-medium flex items-center justify-center gap-2 hover:border-[#00609c] hover:text-[#00609c] transition-all"
                  >
                    <Play className="w-5 h-5" /> {t('srp.hero.video', 'Watch video')}
                  </a>
                </div>
                <p className="text-xs text-slate-400 mt-3 font-light">
                  {t('srp.hero.footnote', '*Full version. No credit card required.')}
                </p>
              </FadeIn>
            </div>
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <FadeIn direction="up">
            ...
            <a href="/customers" className="text-[#00609c] hover:underline font-light text-sm">
      ...
      <section className="py-16 bg-slate-50 border-t border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-7xl">
          {FEATURES_DATA.map(feature => (
            <div
              key={feature.id}
              className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-24 py-16 ${feature.reversed ? 'lg:flex-row-reverse' : ''} ${feature.id !== 1 ? 'border-t border-slate-200' : ''}`}
            >
                ...
                >
                  ...
                  {feature.id === 3 && (
                    <div className="mt-8">
                      <a
                        href="/features"
                        className="bg-[#00609c] text-white px-8 py-3 rounded font-medium hover:bg-[#004d7d] transition-colors shadow-sm inline-block"
                      >
      ...
      <section className="py-20 bg-[#6dd5ed]/20 text-center border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-3xl">
          <FadeIn direction="up">
            <h2 className="text-3xl lg:text-4xl font-medium text-slate-800 mb-6">
              {t('srp.guide.title', 'The ultimate route planning guide for sales reps')}
            </h2>
            <p className="text-lg text-slate-600 font-light mb-8">
              {t(
                'srp.guide.desc',
                'An automatic sales route planner app is the smart way to manage your visits. Learn how to get started with our ultimate sales route planning guide.',
              )}
            </p>
            <a
              href="/blog/guide"
              className="bg-[#f0ad4e] hover:bg-[#e09e3e] text-white px-8 py-3 rounded font-medium transition-colors shadow-md"
            >
              {t('srp.guide.btn', 'Read our sales route planning guide')}
            </a>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full lg:w-1/2 flex justify-center">
              <FadeIn direction={isRTL ? 'right' : 'left'}>
                <img
                  src="/assets/images/portatour-integrations.webp"
                  alt="Integrations"
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              <FadeIn direction="up">
                <h2 className="text-4xl font-medium text-slate-800">
                  {t('srp.integrations.title', 'Integrations')}
                </h2>
                <p className="text-lg text-slate-500 font-light leading-relaxed mt-4">
                  {t(
                    'srp.integrations.desc',
                    'Up-to-date data is essential for sales route planning.',
                  )}
                </p>
                <ul className="flex flex-col gap-4 mt-6 mb-8">
                  {[
                    t('srp.integrations.b1', 'Fast and easy manual data import'),
                    t('srp.integrations.b2', 'Out-of-the-box integrations'),
                    t('srp.integrations.b3', 'Automated data synchronisation'),
                  ].map((item, idx) => (
                ...
                <a
                  href="/integrations"
                  className="bg-[#00609c] text-white px-8 py-3 rounded font-medium hover:bg-[#004d7d] transition-colors w-fit shadow-sm"
                >
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <FadeIn direction="up">
            <h2 className="text-3xl lg:text-4xl font-medium text-slate-800 text-center mb-16">
              {t('srp.testimonials.title', 'Customer stories')}
            </h2>
          </FadeIn>
          ...
          <FadeIn direction="up" delay={100}>
            <div className="bg-white border border-slate-200 p-8 lg:p-12 rounded-lg shadow-sm">
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start min-h-[220px]">
                <div className="flex flex-col items-center shrink-0 md:w-1/3 md:border-r border-slate-100 md:pr-8">
                  ...
                  />
                  <Quote
                    className={`w-10 h-10 text-[#00609c] opacity-80 ${isRTL ? '' : 'rotate-180'}`}
                  />
                </div>
                ...
                <div className="md:w-2/3 flex flex-col justify-center text-center md:text-left">
                  <img
                    ...
                    alt="Logo"
                    className={`h-8 mb-6 object-contain ${isRTL ? 'mx-auto md:mr-0 md:ml-auto' : 'mx-auto md:ml-0 md:mr-auto'}`}
                  />
                  <p className="text-slate-600 font-light mb-8 leading-relaxed text-[17px]">
                    {TESTIMONIALS[currentSlide].text}
                  </p>
                  <div className="mt-auto">
                    <div className="text-[#a0a0a0] font-light text-[15px]">
                    ...
                    <div className="mt-4">
                      <a href="#" className="text-[#00609c] hover:underline font-light text-sm">
            ...
            <div className="flex items-center justify-center gap-6 mt-10">
              <button
                ...
                className="text-slate-400 hover:text-[#00609c] transition-colors focus:outline-none"
              >
            ...
            <div className="text-center mt-12">
              <a
                href="/customers"
                className="bg-[#00609c] text-white px-6 py-2.5 rounded hover:bg-[#004d7d] transition-colors inline-block text-[15px]"
              >
                {t('srp.customers.learnMore', 'Learn more about our customers')}
              </a>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-5xl">
          <FadeIn direction="up">
            <h2 className="text-3xl lg:text-[44px] font-medium text-white mb-10 leading-tight">
              {t('srp.cta.title', 'Increase your customer visits by up to')}{' '}
              <em className="text-[#f0ad4e] not-italic font-bold">
                {t('srp.cta.highlight', '25%')}
              </em>{' '}
              {t('srp.cta.rest', 'with S-Locator')}
            </h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <FadeIn direction="up">
            <h2 className="text-3xl lg:text-[40px] font-medium text-slate-800 text-center mb-16">
              {t('srp.faq.title', 'Frequently asked questions')}
            </h2>
          </FadeIn>
              ...
              <div className="bg-white p-10 rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.05)] border border-slate-100 text-center flex flex-col items-center h-full">
                ...
                <div className="flex flex-col gap-4 text-[#00609c] font-light text-[15px] items-start w-full max-w-xs mx-auto mt-2">
                  ...
                  <div className={`w-full ${isRTL ? 'text-right pr-8' : 'text-left pl-8'}`}>
                    <a
                      href="/contact"
                      className="text-sm text-[#a0a0a0] hover:text-[#00609c] transition-colors"
                    >
