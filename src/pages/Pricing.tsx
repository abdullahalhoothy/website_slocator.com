...
export const Pricing: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-[#f8fafc] font-sans text-slate-900 selection:bg-[#f5f3ff] selection:text-[#8A2BE2] pb-0 ${isRTL ? 'text-right' : 'text-left'}`}
    >
      <section className="bg-[#f8fafc] pt-24 pb-12 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <FadeIn direction="up">
            ...
            <h2 className="text-2xl font-light text-slate-500">{t('pricingPage.hero.subtitle')}</h2>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl flex flex-col lg:flex-row gap-8 items-start relative">
          <div className="w-full lg:w-2/3 flex flex-col gap-6 pb-16">
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 flex items-center justify-center bg-[#f5f3ff] rounded-full shrink-0">
                    <img
                      src="/assets/images/icon-route-planner.svg"
                      alt=""
                      className={`w-8 h-8 ${product !== 'rp' && 'grayscale opacity-50'}`}
                      onError={e => (e.currentTarget.style.display = 'none')}
                    />
                  </div>
                  <div>
                    <h3
                      className={`text-xl font-bold ${product === 'rp' ? 'text-[#8A2BE2]' : 'text-slate-700'}`}
                    >
                      {t('pricingPage.configurator.products.rp')}
                    </h3>
                    <p className="text-sm text-slate-400 mt-1">
                      {t('pricingPage.configurator.products.min1')}
                    </p>
                  </div>
                </div>
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 ${product === 'rp' ? 'border-[#8A2BE2]' : 'border-slate-300'}`}
                >
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 flex items-center justify-center bg-[#f5f3ff] rounded-full shrink-0">
                    <img
                      src="/assets/images/icon-territory-optimization.svg"
                      alt=""
                      className={`w-8 h-8 ${product !== 'to' && 'grayscale opacity-50'}`}
                      onError={e => (e.currentTarget.style.display = 'none')}
                    />
                  </div>
                  <div>
                    <h3
                      className={`text-xl font-bold ${product === 'to' ? 'text-[#8A2BE2]' : 'text-slate-700'}`}
                    >
                      {t('pricingPage.configurator.products.to')}
                    </h3>
                    <p className="text-sm text-slate-400 mt-1">
                      {t('pricingPage.configurator.products.min2')}
                    </p>
                  </div>
                </div>
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 ${product === 'to' ? 'border-[#8A2BE2]' : 'border-slate-300'}`}
                >
              ...
              >
                <div className="flex items-center gap-6">
                  <div
                    className={`flex items-center ${product !== 'rpto' && 'grayscale opacity-50'}`}
                  >
                  ...
                  <div>
                    <h3
                      className={`text-xl font-bold ${product === 'rpto' ? 'text-[#8A2BE2]' : 'text-slate-700'}`}
                    >
                      {t('pricingPage.configurator.products.rpto')}
                    </h3>
                    <p className="text-sm text-slate-400 mt-1">
                      {t('pricingPage.configurator.products.min2')}
                    </p>
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 ${product === 'rpto' ? 'border-[#8A2BE2]' : 'border-slate-300'}`}
                >
            ...
            <div className="mt-8 bg-white p-6 rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              <h3 className="text-2xl font-light text-slate-800 mb-6">
                {t('pricingPage.configurator.licenses.title')}
              </h3>

              <div className="flex w-full overflow-x-auto pb-4">
                <div
                  className={`flex flex-col w-[35%] shrink-0 ${isRTL ? 'pl-4' : 'pr-4'} gap-4 text-sm font-light text-slate-600`}
                >
                  <div className="h-16 flex items-end pb-2">
                    <div className="flex flex-col w-full">
                      <span className="text-xs">
                        {t('pricingPage.configurator.licenses.persons')} *
                      </span>
                      <input
                        type="text"
                        disabled
                        value={usersTier === 50 ? '50+' : usersTier}
                        className="w-20 border border-slate-300 rounded px-2 py-1 mt-1 bg-slate-50 text-center font-bold text-slate-700"
                      />
                    </div>
                  </div>
                  <div className="h-10 flex flex-col justify-center">
                    <span className="text-[#489E46] font-bold">
                      {t('pricingPage.configurator.licenses.savings')}
                    </span>
                    <span className="text-xs text-slate-400">
                      {t('pricingPage.configurator.licenses.perMonth')}
                    </span>
                  </div>
                  <div className="h-10 flex items-center">
                    {t('pricingPage.configurator.licenses.features.rp')}
                  </div>
                  <div className="h-10 flex items-center">
                    {t('pricingPage.configurator.licenses.features.to')}
                  </div>
                  <div className="h-10 flex items-center">
                    {t('pricingPage.configurator.licenses.features.import')}
                  </div>
                  <div className="h-10 flex items-center">
                    {t('pricingPage.configurator.licenses.features.api')}
                  </div>
                  <div className="h-10 flex items-center leading-tight">
                    {t('pricingPage.configurator.licenses.features.groups')}
                  </div>
                  <div className="h-10 flex items-center">
                    {t('pricingPage.configurator.licenses.features.integrations')}
                  </div>
                </div>
                  ...
                  return (
                    ...
                    >
                      <div className="h-16 flex flex-col items-center justify-end pb-2 gap-2">
                        <div
                          className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${isActive ? 'border-[#8A2BE2]' : 'border-slate-300'}`}
                        >
                          {isActive && <div className="w-2 h-2 rounded-full bg-[#8A2BE2]"></div>}
                        </div>
                        <span className={isActive ? 'text-[#8A2BE2]' : 'text-slate-600'} dir="ltr">
                          {tier.label}
                        </span>
                      </div>

                      <div
                        className={`h-10 flex items-center justify-center w-full ${isActive ? 'text-[#489E46]' : 'text-slate-400'}`}
                        dir="ltr"
                      >
                        {tier.val === 50 ? (
                      ...
                      <div className="h-10 flex items-center justify-center w-full">
                        <Check
                          className={`w-5 h-5 ${isActive ? 'text-[#489E46]' : 'text-slate-300'}`}
                          strokeWidth={3}
                        />
                      </div>
                      <div className="h-10 flex items-center justify-center w-full">
                        {(product === 'to' || product === 'rpto') && tier.val > 1 ? (
                          <Check
                            className={`w-5 h-5 ${isActive ? 'text-[#489E46]' : 'text-slate-300'}`}
                            strokeWidth={3}
                          />
                      ...
                      <div
                        className={`absolute -bottom-[2px] left-0 w-full h-[2px] ${isActive ? 'bg-[#f5f3ff]' : 'bg-slate-200'}`}
                      ></div>
                    </button>
                  )
                })}
            ...
            <div className="mt-4 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 transition-transform ${showIntegrations ? 'rotate-180' : ''}`}
                />
              </button>
              {showIntegrations && (
                <div className="p-5 border-t border-slate-100 flex flex-col gap-3">
                  {[
                    {
                      id: 'api',
                      name: t('pricingPage.configurator.integrations.api'),
                      min: t('pricingPage.configurator.integrations.min2'),
                      disabled: usersTier < 2,
                    },
                    {
                      id: 'sf',
                      name: t('pricingPage.configurator.integrations.salesforce'),
                      min: t('pricingPage.configurator.integrations.min10'),
                      disabled: usersTier < 10,
                    },
                    {
                      id: 'dyn',
                      name: t('pricingPage.configurator.integrations.dynamics'),
                      min: t('pricingPage.configurator.integrations.min10'),
                      disabled: usersTier < 10,
                    },
                    {
                      id: 'veeva',
                      name: t('pricingPage.configurator.integrations.veeva'),
                      min: t('pricingPage.configurator.integrations.min50'),
                      disabled: usersTier < 50,
                    },
                    {
                      id: 'none',
                      name: t('pricingPage.configurator.integrations.none'),
                      min: '',
                      disabled: false,
                    },
                  ].map(opt => (
                    <label
                      key={opt.id}
                      className={`flex items-center justify-between p-3 rounded-lg border ${integration === opt.id ? 'border-[#8A2BE2] bg-[#f5f3ff]' : 'border-slate-200'} ${opt.disabled ? 'opacity-40 cursor-not-allowed' : 'cursor-pointer hover:bg-slate-50'}`}
                    >
                  ...
                  <a
                    href="/integrations"
                    className="text-[#8A2BE2] hover:underline text-sm font-medium mt-2 flex items-center gap-1"
                  >
                    {t('pricingPage.configurator.integrations.link')}{' '}
            ...
            <div className="mt-8">
              <h3 className="text-2xl font-light text-slate-800 mb-6">
                {t('pricingPage.configurator.billing.title')}
              </h3>
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <span
                      className={`text-xl font-bold ${billing === 3 ? 'text-[#8A2BE2]' : 'text-slate-700'}`}
                    >
                      {t('pricingPage.configurator.billing.m3')}
                    </span>
                    <div
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${billing === 3 ? 'border-[#8A2BE2]' : 'border-slate-300'}`}
                    >
                      {billing === 3 && (
                        <div className="w-2.5 h-2.5 rounded-full bg-[#8A2BE2]"></div>
                      )}
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <span
                      className={`text-xl font-bold ${billing === 12 ? 'text-[#8A2BE2]' : 'text-slate-700'}`}
                    >
                      {t('pricingPage.configurator.billing.m12')}
                    </span>
                    <div
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${billing === 12 ? 'border-[#8A2BE2]' : 'border-slate-300'}`}
                    >
                      {billing === 12 && (
                        <div className="w-2.5 h-2.5 rounded-full bg-[#8A2BE2]"></div>
                      )}
                  ...
                  {savings && (
                    <p className="text-[#489E46] font-bold text-sm" dir="ltr">
                      {t('pricingPage.configurator.licenses.save')} €{savings}{' '}
                      <span className="font-light text-slate-500 block text-xs mt-0.5">
                        {t('pricingPage.configurator.licenses.perMonth')}
                      </span>
                    </p>
                  )}
              ...
              <p className="text-sm text-slate-500 mt-4">
                {t('pricingPage.configurator.billing.note')}
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/3 sticky top-28 bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100 flex flex-col z-20">
            <div className="p-8 pb-10 flex flex-col items-center text-center">
              <h3
                className={`text-2xl font-light text-slate-600 mb-6 w-full ${isRTL ? 'text-right' : 'text-left'}`}
              >
                {t('pricingPage.configurator.stickyBox.title')}
              </h3>

              {displayPrice === 'request' || !displayPrice ? (
                <div className="flex flex-col items-center justify-center py-4 text-center">
                  <h4 className="text-3xl font-bold text-[#8A2BE2] mb-4" dir="ltr">
                    50+ licenses
                  </h4>
                  <p className="text-slate-500 mb-8">
                    {t('pricingPage.configurator.stickyBox.contactSales')}
                  </p>
                  <a
                    href="/contact"
                    className="w-full bg-[#8A2BE2] text-white py-3.5 rounded font-bold hover:bg-[#6b21a8] transition-colors tracking-wide"
                  >
                ...
                <div
                  className={`flex flex-col w-full ${isRTL ? 'text-right items-end' : 'text-left items-start'}`}
                >
                  <div className="flex items-baseline gap-1 mb-4" dir="ltr">
                    <span className="text-5xl font-bold text-[#8A2BE2]">€</span>
                    <span className="text-7xl font-bold text-[#8A2BE2] tracking-tighter">
                      {Math.floor(displayPrice as number)}
                    </span>
                    <span className="text-3xl font-bold text-[#8A2BE2]">
                      ,{(displayPrice as number).toFixed(2).split('.')[1]}
                    </span>
                  </div>
                  <div className="text-sm text-[#6b21a8] font-medium leading-relaxed">
                    ...
                    <p className="mt-4 text-slate-400">
                      {t('pricingPage.configurator.stickyBox.vat')}
                    </p>
                  </div>
                </div>
              )}
            ...
            <div
              className={`bg-[#8A2BE2] p-8 text-white flex flex-col ${isRTL ? 'items-end text-right' : 'items-start text-left'}`}
            >
              <h4 className="font-bold text-lg mb-1">
                {t('pricingPage.configurator.stickyBox.worthTitle')}
              </h4>
              <p className="text-purple-100 text-sm mb-6 leading-relaxed">
                {t('pricingPage.configurator.stickyBox.worthDesc')}
              </p>

              <a
                href="/roi"
                className="block w-full bg-[#489E46] hover:bg-[#336E2E] text-white text-center py-3.5 rounded font-bold transition-colors"
              >
            ...
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-6 text-left max-w-5xl mx-auto">
              {faqQuestions.map((q, i) => (
                <a
                  key={i}
                  href="/faq"
                  className={`text-[17px] font-medium text-[#8A2BE2] hover:text-[#489E46] transition-colors py-2 border-b border-slate-100 leading-snug block ${isRTL ? 'text-right' : 'text-left'}`}
                >
                  {q}
                </a>
              ))}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto mt-16 mb-8">
            <div className="flex-1 bg-white p-10 rounded-xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              <h3 className="text-[17px] font-medium text-[#489E46] mb-2">
                {t('contactPage.support.pretitle')}
              </h3>
              <h4 className="text-[32px] font-bold text-[#8A2BE2] mb-8">
              ...
              <div className="text-left flex flex-col gap-4 text-[#8A2BE2] font-medium text-[15px] items-start w-full max-w-xs mx-auto">
                <div className="flex items-center gap-3" dir="ltr">
                  <Phone className="w-5 h-5 text-[#489E46]" /> KSA: +966 55 818 8632
                </div>
                <div className="flex items-center gap-3 mt-2">
                  <Mail className="w-5 h-5 text-[#489E46]" /> support@s-locator.com
                </div>
              </div>
            </div>
            <div className="flex-1 bg-white p-10 rounded-xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              ...
              <div className="text-left flex flex-col gap-4 text-[#8A2BE2] font-medium text-[15px] items-start w-full max-w-xs mx-auto mt-2">
                <div className="flex items-center gap-3" dir="ltr">
                  <Phone className="w-5 h-5 text-[#489E46]" /> Canada: +1 514-814-5180
                </div>
                <div className="flex items-center gap-3" dir="ltr">
                  <Phone className="w-5 h-5 text-[#489E46]" /> KSA: +966 55 818 8632
                </div>
                ...
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-[#489E46]" /> sales@s-locator.com
                </div>
              </div>
            </div>
          </div>
