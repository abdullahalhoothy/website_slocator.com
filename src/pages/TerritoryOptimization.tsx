...
const ImageSwitcher: React.FC<{
  ...
  const textCol = (
    <div className="w-full lg:w-5/12 flex flex-col gap-6">
      ...
      <div
        className={`flex flex-col gap-1 border-slate-100 ${isRTL ? 'border-r-2 pr-4' : 'border-l-2 pl-4'}`}
      >
        {tabs.map((tab, idx) => (
          <button
            key={idx}
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-20 py-20 border-b border-slate-200 ${imagePosition === 'left' && !isRTL ? 'lg:flex-row-reverse' : ''} ${imagePosition === 'right' && isRTL ? 'lg:flex-row-reverse' : ''}`}
    >
      {imagePosition === 'right' ? (
        <>
          {textCol}
    ...
    <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              <img
                ...
                alt="Company Logo"
                className="h-8 object-contain self-start mb-6"
              />
              ...
              <div className="mt-auto flex justify-between items-end">
                ...
                <a
                  href="#"
                  className="text-[#6699b8] hover:text-[#00609c] text-[14px] transition-colors"
                >
      ...
      <div className="flex items-center justify-center gap-6">
        <button
          ...
          className="text-slate-300 hover:text-[#00609c] transition-colors focus:outline-none"
        >
...
export const TerritoryOptimization: React.FC = () => {
  ...
  const USE_CASES = [
    {
      id: 0,
      icon: '/assets/images/img-quit-job.svg',
      label: t('territoryOpt.useCases.tabs.t1'),
      content: t('territoryOpt.useCases.content.t1'),
    },
    {
      id: 1,
      icon: '/assets/images/img-working-hours.svg',
      label: t('territoryOpt.useCases.tabs.t2'),
      content: t('territoryOpt.useCases.content.t2'),
    },
    {
      id: 2,
      icon: '/assets/images/img-traveling.svg',
      label: t('territoryOpt.useCases.tabs.t3'),
      content: t('territoryOpt.useCases.content.t3'),
    },
    {
      id: 3,
      icon: '/assets/images/img-seasonal-optimization.svg',
      label: t('territoryOpt.useCases.tabs.t4'),
      content: t('territoryOpt.useCases.content.t4'),
    },
    {
      id: 4,
      icon: '/assets/images/img-customer-univers.svg',
      label: t('territoryOpt.useCases.tabs.t5'),
      content: t('territoryOpt.useCases.content.t5'),
    },
    {
      id: 5,
      icon: '/assets/images/img-new-market.svg',
      label: t('territoryOpt.useCases.tabs.t6'),
      content: t('territoryOpt.useCases.content.t6'),
    },
  ]
            ...
            <div className="w-full lg:w-1/2 flex justify-center order-2 lg:order-1">
              <FadeIn direction={isRTL ? 'right' : 'left'}>
                <video
                  ...
                  muted
                  playsInline
                  className="w-full max-w-lg rounded-xl shadow-xl border border-slate-100"
                >
                  <source
                    src="https://cdn.portatour.com/2013/img/to-landing/to-ausgangslage-ergebnis-en.mp4"
                    type="video/mp4"
                  />
                </video>
              </FadeIn>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6 order-1 lg:order-2">
              <FadeIn direction="up">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  <a
                    href="/territory-optimization/demo"
                    className="bg-[#00609c] text-white px-8 py-4 rounded font-medium flex items-center justify-center gap-2 hover:bg-[#004d7d] transition-all shadow-md"
                  >
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <FadeIn direction="up">
            ...
            <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-sm border border-slate-100 mb-16">
              <h3 className="text-[17px] font-medium text-[#00609c] mb-2">
                {t('territoryOpt.useCases.faqQ')}
              </h3>
              <p className="text-[15px] text-slate-600 font-light leading-relaxed">
                {t('territoryOpt.useCases.faqA')}
              </p>
            </div>
          </FadeIn>
      ...
      <section className="py-24 bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <ImageSwitcher
            ...
            tabs={[
              {
                label: t('territoryOpt.switcher.s1.tab1'),
                image: '/assets/images/img-ausgangslage-landkarte-1920x1140-en.webp',
              },
              {
                label: t('territoryOpt.switcher.s1.tab2'),
                image: '/assets/images/img-ausgangslage-detailansicht-1920x1140-en.webp',
              },
              {
                label: t('territoryOpt.switcher.s1.tab3'),
                image: '/assets/images/img-ausgangslage-jaehrlicher-zeitaufwand-1920x1140-en.webp',
              },
            ]}
          />
          ...
          <ImageSwitcher
            ...
            tabs={[
              {
                label: t('territoryOpt.switcher.s2.tab1'),
                image:
                  '/assets/images/img-optimierungsvorgaben-manuelle-anpassung-1920x1140-en.webp',
              },
              {
                label: t('territoryOpt.switcher.s2.tab2'),
                image: '/assets/images/img-optimierungsvorgaben-optimierung-1920x1140-en.webp',
              },
            ]}
          />
          ...
          <ImageSwitcher
            ...
            tabs={[
              {
                label: t('territoryOpt.switcher.s3.tab1'),
                image: '/assets/images/img-optimierungsergebnis-landkarte-1920x1140-en.webp',
              },
              {
                label: t('territoryOpt.switcher.s3.tab2'),
                image: '/assets/images/img-optimierungsergebnis-detailansicht-1920x1140-en.webp',
              },
            ]}
          />
          ...
          <ImageSwitcher
            ...
            tabs={[
              {
                label: t('territoryOpt.switcher.s4.tab1'),
                image: '/assets/images/img-optimierungsergebnis-schritt-01-1920x1140-en.webp',
              },
              {
                label: t('territoryOpt.switcher.s4.tab2'),
                image: '/assets/images/img-optimierungsergebnis-schritt-07-1920x1140-en.webp',
              },
            ]}
          />
        </div>
            ...
            <div className="w-full lg:w-5/12">
              <FadeIn direction={isRTL ? 'right' : 'left'}>
                <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100 border-t-4 border-t-[#00609c]">
                  <h4 className="text-xl font-medium text-[#00609c] mb-6">
                    {t('territoryOpt.saas.boxTitle')}
                  </h4>
                  <ul className="flex flex-col gap-5">
                    ...
                    <li className="flex items-center gap-3 text-slate-700 font-light">
                      <MonitorSmartphone className="w-5 h-5 text-[#00609c]" />{' '}
                      {t('territoryOpt.saas.b2')}
                    </li>
                    <li className="flex items-center gap-3 text-slate-700 font-light">
          ...
          <FadeIn direction="up">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              <div className="bg-white p-10 rounded-xl shadow-sm border border-slate-100 flex flex-col items-center hover:shadow-md transition-shadow">
                ...
                <div className="text-2xl font-medium text-slate-800 mb-6">
                  {t('territoryOpt.pricing.m3')}
                </div>
              ...
              <div className="bg-white p-10 rounded-xl shadow-sm border border-[#00609c]/20 relative flex flex-col items-center hover:shadow-md transition-shadow">
                <div
                  className={`absolute top-0 ${isRTL ? 'left-0 rounded-bl-lg rounded-tr-xl' : 'right-0 rounded-bl-lg rounded-tr-xl'} bg-[#44E559] text-white text-xs font-bold px-3 py-1`}
                >
                  {t('territoryAdvantages.pricing.popular')}
                </div>
                <div className="text-6xl font-light text-[#00609c] mb-2">12</div>
                <div className="text-2xl font-medium text-slate-800 mb-6">
                  {t('territoryOpt.pricing.m12')}
                </div>
                <hr className="w-16 border-t-2 border-[#f0ad4e] mb-6" />
                <p className="text-slate-500 font-light leading-relaxed mb-8 flex-grow">
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <FadeIn direction="up">
            <h3 className="text-2xl font-medium text-slate-800 mb-6">
              {t('territoryOpt.footerCta.title')}
            </h3>
            ...
            <a
              ...
              className={`inline-flex items-center gap-2 bg-white border-2 border-[#00609c] text-[#00609c] hover:bg-[#00609c] hover:text-white transition-colors px-8 py-3.5 rounded font-medium ${isRTL ? 'flex-row-reverse' : ''}`}
            >
              {t('territoryOpt.footerCta.btn')}{' '}
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <FadeIn direction={isRTL ? 'left' : 'right'}>
              <div className="bg-white p-10 rounded shadow-sm border border-slate-100 text-center flex flex-col items-center">
                ...
                <div
                  className={`flex flex-col gap-4 text-[#00609c] font-light text-[15px] w-full max-w-xs mx-auto ${isRTL ? 'items-start text-right' : 'items-start text-left'}`}
                >
            ...
            <FadeIn direction={isRTL ? 'right' : 'left'} delay={200}>
              <div className="bg-white p-10 rounded shadow-sm border border-slate-100 text-center flex flex-col items-center">
                ...
                <div
                  className={`flex flex-col gap-4 text-[#00609c] font-light text-[15px] w-full max-w-xs mx-auto mt-2 ${isRTL ? 'items-start text-right' : 'items-start text-left'}`}
                >
                  <div className="flex items-center gap-3" dir="ltr">
