...
export const Customers: React.FC = () => {
  ...
  const stories = [
    {
      ...
      quote: "S-Locator not only helps us with planning, but above all with bringing transparency to our field sales operations.",
      author: "Philip Wilms",
    ...
    },
    {
      ...
      quote: "With S-Locator, scheduling is no longer part of the job. It simply happens automatically.",
      author: "Oscar George",
    ...
    },
    {
      ...
      quote: "With S-Locator, our field reps save 30 to 45 minutes per day in route planning and preparation.",
      author: "Jonas Seidl",
    ...
    },
    {
      ...
      quote: "A dynamic company such as Samsung requires a dynamic route planner! Call frequencies are now in firm control thanks to S-Locator.",
    ...
    },
    {
      ...
      quote: "SONAX sales representatives like working with S-Locator because they can reschedule flexibly on the road and the software is very user-friendly.",
      author: "Florian Behmer",
      role: "Sales Management Assistant",
      company: "SONAX"
    },
    {
      ...
      quote: "With S-Locator we get an extra 20% visits to accounts in any given week. S-Locator is a huge time-saver for us.",
      author: "Ian Henry",
      role: "VP Field Sales",
      company: "trupanion"
    },
    {
      ...
      quote: "I wouldn't want to be without S-Locator now. The software is worth the money because when you factor in the labor costs of manual processing, it pays for itself.",
    ...
    },
    {
      ...
      quote: "Thanks to S-Locator, we can quickly turn our field sales requirements into reality and get optimized results at the touch of a button.",
      author: "Jonas Gronau",
      role: "Sr. Sales Operations Manager",
      company: "HOLY"
    },
    {
      ...
      quote: "For us, S-Locator is the ultimate solution because it simply works and adapts perfectly to our everyday working life.",
      author: "Moritz Weiss",
      role: "Teamlead Sales Field Manager",
      company: "planted."
    }
  ];
  ...
  const reviews = [
    { author: "Murray Godden", text: "The best system Sales and Marketing could ever purchase for hitting those execution goals, been using it for over 6yrs." },
    { author: "Clint Mallum", text: "This is an amazing application. It helps us save a lot of time on the road and focus on our customers." },
    { author: "Beren Brechtel", text: "Pretty great. The product is excellent and helps our team hit their monthly execution targets efficiently." },
    { author: "Philippe SAUNIER", text: "Just awesome! Time saving, optimization, efficiency, performance... No hassle. Totally recommended." },
    { author: "Alberto Bertamino", text: "Unique tool. It adapts perfectly to our specific needs and the support team is always available." },
    { author: "Frank Burek", text: "Relaxed route planning! It takes the stress out of my daily routine." },
  ];
               ...
               <div className="flex gap-6 overflow-x-auto pb-8 snap-x snap-mandatory scrollbar-hide">
                  {reviews.map((review, idx) => (
                     <div key={idx} className="min-w-[300px] md:min-w-[350px] bg-white p-8 rounded-2xl shadow-sm border border-slate-100 snap-center shrink-0 flex flex-col">
                        ...
                        <div className="flex text-[#f0ad4e] mb-4">
          ...
          <FadeIn direction="up">
             ...
             <div className="grid md:grid-cols-2 gap-x-16 gap-y-6 text-left max-w-5xl mx-auto">
                {[
                  ...
                  "Will S-Locator record the routes I drive?",
                  "Can I use S-Locator with Salesforce, Dynamics CRM or other CRM/ERP systems?",
                  "Can I integrate the route planning algorithm into my own field rep app?",
                  "Somebody calls and wants to have an appointment - how does S-Locator react?",
                  "Can S-Locator help me avoid traffic jams?",
                  "Does the S-Locator route planner help me win new leads?",
                  "Is there an offline version of S-Locator?"
                ].map((q, i) => (
                  <a key={i} href="/faq" className="text-[17px] font-medium text-[#8A2BE2] hover:text-[#489E46] transition-colors py-3 border-b border-slate-100 leading-snug block">
                    {q}
                  </a>
                ))}
             </div>
