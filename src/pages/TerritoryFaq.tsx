...
const FaqItem: React.FC<{ question: string; answer: string; isRTL: boolean }> = ({
  question,
  answer,
  isRTL,
}) => {
  ...
  return (
    <div className="border-b border-slate-200 py-6 last:border-0 bg-white">
      ...
      >
        <h3
          className={`text-[17px] font-medium text-[#8A2BE2] group-hover:text-[#489E46] leading-relaxed transition-colors ${isRTL ? 'pl-6' : 'pr-6'}`}
        >
          {question}
        </h3>
...
export const TerritoryFaq: React.FC = () => {
  ...
  const faqCategories = [
    ...
    },
    {
      ...
      faqs: [
        {
          q: t('territoryFaq.categories.industries.q1'),
          a: t('territoryFaq.categories.industries.a1'),
        },
        {
          q: t('territoryFaq.categories.industries.q2'),
          a: t('territoryFaq.categories.industries.a2'),
        },
      ],
    },
    {
      ...
      faqs: [
        {
          q: t('territoryFaq.categories.security.q1'),
          a: t('territoryFaq.categories.security.a1'),
        },
        {
          q: t('territoryFaq.categories.security.q2'),
          a: t('territoryFaq.categories.security.a2'),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      faqs: [
        {
          q: t('territoryFaq.categories.purchase.q1'),
          a: t('territoryFaq.categories.purchase.a1'),
        },
      ],
    },
    {
      ...
      faqs: [
        {
          q: t('territoryFaq.categories.integrations.q1'),
          a: t('territoryFaq.categories.integrations.a1'),
        },
      ],
    },
  ]
      ...
      <section className="bg-[#8A2BE2] py-24 text-center relative">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          <FadeIn direction="up">
            ...
            <p className="text-purple-200 text-sm font-light">{t('territoryFaq.cta.note')}</p>
          </FadeIn>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto mt-16 mb-8">
            ...
            <div className="flex-1 bg-white p-10 rounded-xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              ...
              <div
                className={`flex flex-col gap-4 text-[#8A2BE2] font-medium text-[15px] w-full max-w-xs mx-auto ${isRTL ? 'items-start text-right' : 'items-start text-left'}`}
              >
            ...
            <div className="flex-1 bg-white p-10 rounded-xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              ...
              <div
                className={`flex flex-col gap-4 text-[#8A2BE2] font-medium text-[15px] w-full max-w-xs mx-auto mt-2 ${isRTL ? 'items-start text-right' : 'items-start text-left'}`}
              >
                <div className="flex items-center gap-3" dir="ltr">
