      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        <FadeIn direction="up">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-500 font-light">{t('advantages.subtitle')}</p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-slate-50 p-8 rounded-2xl border border-slate-100">
          <div className="w-full lg:w-5/12">
            <FadeIn direction={isRTL ? 'right' : 'left'}>
              <div
                className={`flex gap-6 items-start border-b lg:border-b-0 ${isRTL ? 'lg:border-l lg:pl-8' : 'lg:border-r lg:pr-8'} border-slate-200 pb-8 lg:pb-0`}
              >
                <div className="flex flex-col items-center gap-3">
                  <img
                    src="/assets/images/pieterniemand_rund_web.webp"
                    alt="Pieter Niemand"
                    className="w-20 h-20 rounded-full object-cover shadow-sm"
                  />
                  <Quote
                    className={`w-8 h-8 text-purple-600 fill-purple-100 opacity-50 ${isRTL ? '' : 'rotate-180'}`}
                  />
                </div>
                <div>
                  <img
                    src="/assets/images/miwa-logo.webp"
                    alt="MIWA Logo"
                    className="h-6 mb-4 grayscale opacity-70"
                  />
                  ...
                  <div className="text-sm text-slate-500 font-light mb-2">
          ...
          <div className="w-full lg:w-7/12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <FadeIn direction="up" delay={100}>
              <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm text-center flex flex-col items-center justify-center h-full">
                ...
                <div
                  className={`font-medium text-slate-800 flex items-center justify-center gap-1 flex-wrap ${isRTL ? 'flex-row-reverse' : ''}`}
                >
