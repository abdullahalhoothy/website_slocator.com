...
export const Customers: React.FC = () => {
  ...
  return (
    <section
      className={`py-20 bg-slate-50 border-b border-slate-200 ${isRTL ? 'text-right' : 'text-left'}`}
    >
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10 max-w-4xl mx-auto">
          {categories.map((cat, idx) => (
            <div
              key={idx}
              className="flex items-center gap-2 text-sm text-slate-600 bg-white px-4 py-2 rounded-full border border-slate-200 shadow-sm"
            >
