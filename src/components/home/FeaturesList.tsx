...
const FEATURES_DATA = [
  {
    ...
    testimonial: {
      text: "A colleague got to know his territory in a completely new way through S-Locator. He also rediscovered forgotten customers.",
  ...
  },
  {
    ...
    bullets: [
      ...
      'You use the ready-to-go S-Locator SaaS solution.',
      'Get started after a short training session, we are happy to help.'
    ],
    image: '/assets/images/portatour-schedule.webp',
    testimonial: {
      text: "We chose S-Locator, among others, because it was the most intuitive and easiest to set up.",
  ...
  },
  {
    ...
    testimonial: {
      text: "Integrating S-Locator into our CRM was a crucial step that simplified our processes and boosted efficiency even further.",
        ...
        {FEATURES_DATA.map((feature, index) => (
          <div key={feature.id} className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-24 py-16 ${index !== 0 ? 'border-t border-slate-100' : ''} ${feature.reversed ? 'lg:flex-row-reverse' : ''}`}>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              <FadeIn direction={feature.reversed ? "right" : "left"}>
                ...
                {feature.testimonial && (
                  <div className="mt-6 bg-slate-50 border border-slate-100 p-6 rounded-2xl flex gap-5 shadow-sm">
                    <div className="flex flex-col items-center shrink-0">
                      ...
                      <Quote className="w-6 h-6 text-purple-300 fill-purple-100 rotate-180" />
                    </div>
                    <div>
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <FadeIn direction={feature.reversed ? "left" : "right"}>
