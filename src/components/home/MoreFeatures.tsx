        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-24 border-t border-slate-100 pt-20">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6">
            <FadeIn direction="right">
              ...
              <a href="/isv-api" className="text-purple-600 hover:underline font-medium text-sm mt-4">More about the ISV API</a>
            </FadeIn>
          </div>
        </div>
            ...
            <FadeIn direction="left">
              ...
              <ul className="flex flex-col gap-4 mt-4">
                {[
                  ...
                  'Certified ISO 27018 and 27001 company',
                  'Secure data center with real-time AI processing'
                ].map((bullet, i) => (
                  <li key={i} className="flex items-start gap-3 text-slate-600 font-light">
                    <CheckCircle2 className="w-5 h-5 text-purple-500 shrink-0 mt-0.5" />
                    <span className="leading-relaxed">{bullet}</span>
              ...
              <div className="mt-6 bg-slate-50 border border-slate-100 p-6 rounded-2xl flex gap-5 shadow-sm">
                ...
                <div>
                  <p className="text-slate-700 italic font-light mb-3 text-[15px] leading-relaxed">"We definitely recommend S-Locator as an optimal planning tool!"</p>
              ...
              <a href="/security" className="text-purple-600 hover:underline font-medium text-sm mt-4">More on data protection and information security</a>
            </FadeIn>
          </div>
        </div>
